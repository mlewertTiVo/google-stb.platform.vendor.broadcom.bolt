$VAR1 = {
          'rdb_sha1' => 'tNllIeUJx4dBwWU/hgWyo79gkY0',
          'fail' => 0,
          'date' => 'Thu Feb  8 13:05:45 PST 2018',
          'rdb_version' => 'rdb-v2-66-g0cc583f',
          'rdb_dir' => '/projects/stbgit/stblinux/git/clkgen/7255a0',
          'clkgen_version' => 'clkgen-v4-473-g0f9bfe0-dirty',
          'pm_ver' => '???',
          'chip' => '7255a0',
          'aliases' => {},
          'unhandled_linux_funcs' => 'CPU, MEMSYS0, MPI',
          'invocation' => 'clkgen.pl --sw_nodes -v -g -r -p -c 7255a0 -D',
          'num_clks' => 109,
          'clks' => '	brcmstb-clks {
		#address-cells = <1>;
		#size-cells = <1>;
		...
		net_ldo_pwron : net_ldo_pwron@f04e00b0 {
			compatible = "brcm,brcmstb-gate-clk";
			#clock-cells = <0>;
			reg = <0xf04e00b0 0x4>;
			bit-shift = <0>;
		...
		net_pll_rsta : net_pll_rsta@f04e00c4 {
			compatible = "brcm,brcmstb-gate-clk";
			#clock-cells = <0>;
			reg = <0xf04e00c4 0x4>;
			bit-shift = <0>;
		...
		net_pll_rstd : net_pll_rstd@f04e00c4 {
			compatible = "brcm,brcmstb-gate-clk";
			#clock-cells = <0>;
			reg = <0xf04e00c4 0x4>;
			bit-shift = <1>;
		...
		sw_genet0 : sw_genet0 {
			compatible = "brcm,brcmstb-sw-clk";
			#clock-cells = <0>;
			clocks = <&net_pwrdn_req>, <&genet0_alwayson>,
			  <&genet0_sys_fast>, <&genet0_sys_pm>,
			  <&genet0_sys_slow>, <&genet0_250>, <&genet0_gisb>,
			  <&genet0_gmii>, <&genet0_hfb>, <&genet0_l2intr>,
			  <&genet0_scb>, <&genet0_umac_sys_rx>,
			  <&genet0_umac_sys_tx>, <&genet_54>, <&genet_scb>;
			clock-names = "net_pwrdn_req", "genet0_alwayson",
			  "genet0_sys_fast", "genet0_sys_pm",
			  "genet0_sys_slow", "genet0_250", "genet0_gisb",
			  "genet0_gmii", "genet0_hfb", "genet0_l2intr",
			  "genet0_scb", "genet0_umac_sys_rx",
