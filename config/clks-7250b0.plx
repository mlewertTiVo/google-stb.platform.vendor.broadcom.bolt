$VAR1 = {
          'rdb_sha1' => 'i3ZmI+TjE/IhLRtpJrvKZpGg7Ek',
          'fail' => 0,
          'date' => 'Tue May 26 16:05:14 PDT 2015',
          'rdb_version' => 'rdb-v2-14-gc3dd139',
          'rdb_dir' => '/home/stblinux/clkgen/7250b0/current',
          ...
          'invocation' => 'clkgen.pl --sw_nodes -v -g -r -P -c 7250b0',
          'num_clks' => 125,
          'clks' => '	brcmstb-clks {
		#address-cells = <1>;
		#size-cells = <1>;
		reg = <0xf04e0000 0x6bc 0xf04d1800 0xac 0xf0410000 0x400>;
		ranges;
		...
		pcie_alwayson : pcie_alwayson@f04e0520 {
			compatible = "brcm,brcmstb-gate-clk";
			#clock-cells = <0>;
			reg = <0xf04e0520 0x4>;
			bit-shift = <0>;
		...
		sw_pcie : sw_pcie {
			...
			clocks = <&pcie_alwayson>, <&pcie_108>, <&pcie_54>, 
			  <&pcie_gisb>, <&pcie_scb>, <&sys0_mdiv_ch1>, 
			  <&sys0_mdiv_ch2>; 
		...
		sw_sata3 : sw_sata3 {
			compatible = "brcm,brcmstb-sw-clk";
			#clock-cells = <0>;
			clocks = <&pcie_gisb>, <&pcie_scb>, <&sys0_mdiv_ch2>; 
			clock-names = "pcie_gisb", "pcie_scb", 
			  "sys0_mdiv_ch2"; 
		};
...
#                                    /PWRON_PLL
# [---] R pcie_108 => CLKGEN_ONOFF_PCIE_X1_TOP_INST_CLOCK_ENABLE
#                                    /PCIE_108_CLOCK_ENABLE
# [---] R pcie_54 => CLKGEN_ONOFF_PCIE_X1_TOP_INST_CLOCK_ENABLE
#                                    /PCIE_54_CLOCK_ENABLE
# [---] R pcie_alwayson => CLKGEN_ONOFF_PCIE_X1_TOP_INST_CLOCK_DISABLE
#                                    /DISABLE_PCIE_ALWAYSON_CLOCK
# [---] R pcie_gisb => CLKGEN_ONOFF_PCIE_X1_TOP_INST_CLOCK_ENABLE
#                                    /PCIE_GISB_CLOCK_ENABLE
# [---] R pcie_scb => CLKGEN_ONOFF_PCIE_X1_TOP_INST_CLOCK_ENABLE
