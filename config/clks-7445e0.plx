$VAR1 = {
          'rdb_sha1' => '4/H+q9csItFoMtFiSTY7m7j2OPI',
          'fail' => 0,
          'date' => 'Tue Apr 28 11:13:57 PDT 2015',
          'rdb_version' => 'rdb-v2-6-g409e2c5',
          'rdb_dir' => '/home/stblinux/clkgen/7445e0/current',
          'clkgen_version' => 'clkgen-v4-39-g573840e',
          'chip' => '7445e0',
          'aliases' => {
                         'sw_gphy' => 'lc_pdh_ch0'
                       },
          'unhandled_linux_funcs' => 'CPU, MEMSYS0, MEMSYS1, MEMSYS2, MPI',
          'invocation' => 'clkgen.pl --sw_nodes -v -g -r -P -D -c 7445e0',
          'num_clks' => 97,
          'clks' => '	brcmstb-clks {
		#address-cells = <1>;
		#size-cells = <1>;
