$VAR1 = {
          'rdb_sha1' => 'KpVIaobXFEjs6JUQ0HfnDp4UOjI',
          'fail' => 0,
          'date' => 'Tue Mar 22 11:25:45 PDT 2016',
          'rdb_version' => 'rdb-v2-19-g0e3ce42',
          'rdb_dir' => '/home/stblinux/clkgen/7271a0/current',
          'clkgen_version' => 'clkgen-v4-184-g1ef5f26',
          'chip' => '7271a0',
          'aliases' => {},
          'unhandled_linux_funcs' => 'CPU, MEMSYS0, MPI',
          'invocation' => 'clkgen.pl --sw_nodes -v -g -r -P -c 7271a0 -D',
          'num_clks' => 84,
          'clks' => '	brcmstb-clks {
		#address-cells = <1>;
		#size-cells = <1>;
