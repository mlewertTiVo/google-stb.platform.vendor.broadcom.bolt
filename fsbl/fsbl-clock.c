...
/* The hardware default values set the SCB speed at 324MHz, which needs
 * be 388.8MHz for 72604.
 *
 * SCB = 388.8 MHz
 * SID = 349 MHz
 * HVD CPU = 698 MHz
 ...
 * V3D = 582 MHz
 * ------
 * SYS0_PLL VCO = 3888 MHz (P = 1 / N = 72)
 * AVX_PLL VCO = 3492 MHz (P = 3 / N = 194)
 */
static void bcm7260_scb_speed_388mhz(void)
{
	/* SYS0_PLL VCO = 3888 MHz (P = 1 / N = 72)
	 * PLL_SYS0_PLL_DIV
	 *      .PDIV = 1 (default)
	 *      .NDIV_INT = 72 (default)
	 */
	/* SCB Clock = 388.8 (3888 / 10)
	 * PLL_SYS0_PLL_CHANNEL_CTRL_CH_2
	 *      .MDIV_CH0 = 10 (default is 12)
	 */
	BDEV_WR(BCHP_CLKGEN_PLL_SYS0_PLL_CHANNEL_CTRL_CH_2,
		(BCHP_CLKGEN_PLL_SYS0_PLL_CHANNEL_CTRL_CH_2_POST_DIVIDER_HOLD_CH2_DEFAULT <<
			BCHP_CLKGEN_PLL_SYS0_PLL_CHANNEL_CTRL_CH_2_POST_DIVIDER_HOLD_CH2_SHIFT) |
		(BCHP_CLKGEN_PLL_SYS0_PLL_CHANNEL_CTRL_CH_2_PHASE_OFFSET_CH2_DEFAULT <<
			BCHP_CLKGEN_PLL_SYS0_PLL_CHANNEL_CTRL_CH_2_PHASE_OFFSET_CH2_SHIFT) |
		(10 << BCHP_CLKGEN_PLL_SYS0_PLL_CHANNEL_CTRL_CH_2_MDIV_CH2_SHIFT) |
		(BCHP_CLKGEN_PLL_SYS0_PLL_CHANNEL_CTRL_CH_2_CLOCK_DIS_CH2_DEFAULT <<
			BCHP_CLKGEN_PLL_SYS0_PLL_CHANNEL_CTRL_CH_2_CLOCK_DIS_CH2_SHIFT));

	/* AVX_PLL VCO = 3888 MHz (P = 1 / N = 72)
	 * PLL_AVX_PLL_DIV
	 *      .PDIV = 3 (default)
	 *      .NDIV_INT = 194 (default is 200)
	 */
	BDEV_WR(BCHP_CLKGEN_PLL_AVX_PLL_DIV,
		(BCHP_CLKGEN_PLL_AVX_PLL_DIV_PDIV_DEFAULT <<
			BCHP_CLKGEN_PLL_AVX_PLL_DIV_PDIV_SHIFT) |
		(194 << BCHP_CLKGEN_PLL_AVX_PLL_DIV_NDIV_INT_SHIFT));

	/* SID Clock = 349 (3492 / 10)
	 * PLL_AVX_PLL_CHANNEL_CTRL_CH_0
	 *      .MDIV_CH0 = 10
	 */
	BDEV_WR(BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_0,
		(BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_0_POST_DIVIDER_HOLD_CH0_DEFAULT <<
			BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_0_POST_DIVIDER_HOLD_CH0_SHIFT) |
		(BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_0_PHASE_OFFSET_CH0_DEFAULT <<
			BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_0_PHASE_OFFSET_CH0_SHIFT) |
		(10 << BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_0_MDIV_CH0_SHIFT) |
		(BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_0_CLOCK_DIS_CH0_DEFAULT <<
			BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_0_CLOCK_DIS_CH0_SHIFT));

	/* HVD CPU Clock = 698 (3492 / 5)
	 * PLL_AVX_PLL_CHANNEL_CTRL_CH_1
	 *      .MDIV_CH1 = 5
	 */
	BDEV_WR(BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_1,
		...
		(BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_1_PHASE_OFFSET_CH1_DEFAULT <<
			BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_1_PHASE_OFFSET_CH1_SHIFT) |
		(5 << BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_1_MDIV_CH1_SHIFT) |
		(BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_1_CLOCK_DIS_CH1_DEFAULT <<
			BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_1_CLOCK_DIS_CH1_SHIFT));

	/* HVD Core Clock = 698 (3492 / 5)
	 * PLL_AVX_PLL_CHANNEL_CTRL_CH_2
	 *      .MDIV_CH2 = 5
	 */
	BDEV_WR(BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_2,
		...
		(BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_2_PHASE_OFFSET_CH2_DEFAULT <<
			BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_2_PHASE_OFFSET_CH2_SHIFT) |
		(5 << BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_2_MDIV_CH2_SHIFT) |
		(BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_2_CLOCK_DIS_CH2_DEFAULT <<
			BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_2_CLOCK_DIS_CH2_SHIFT));

	/* M2MC Clock = 582 (3492 / 6)
	 * PLL_AVX_PLL_CHANNEL_CTRL_CH_3
	 *      .MDIV_CH3 = 6
	 */
	BDEV_WR(BCHP_CLKGEN_PLL_AVX_PLL_CHANNEL_CTRL_CH_3,
...
#if defined(CONFIG_BCM7260)
	if ((b->prid & (~CHIPID_REV_MASK)) == 0x07260400) /* 72604xx */
		/* increase SCB speed to 388.8MHz */
		bcm7260_scb_speed_388mhz();
#endif
