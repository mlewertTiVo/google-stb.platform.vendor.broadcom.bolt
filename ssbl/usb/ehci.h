...
#define SHOW_XFER_ERR		0x08000000
...
#define G_EHCI_QH_MULT(x)	_EHCI_GETVALUE(x,S_EHCI_QH_MULT,M_EHCI_QH_MULT)

#define S_EHCI_QH_STPN		23
#define M_EHCI_QH_STPN		_EHCI_MAKEMASK(7,S_EHCI_QH_STPN)
#define V_EHCI_QH_STPN(x)	_EHCI_MAKEVALUE(x,S_EHCI_QH_STPN)
#define G_EHCI_QH_STPN(x)	_EHCI_GETVALUE(x,S_EHCI_QH_STPN,M_EHCI_QH_STPN)

#define S_EHCI_QH_STHA		16
#define M_EHCI_QH_STHA		_EHCI_MAKEMASK(7,S_EHCI_QH_STHA)
#define V_EHCI_QH_STHA(x)	_EHCI_MAKEVALUE(x,S_EHCI_QH_STHA)
#define G_EHCI_QH_STHA(x)	_EHCI_GETVALUE(x,S_EHCI_QH_STHA,M_EHCI_QH_STHA)

#define S_EHCI_QH_STCM		8
#define M_EHCI_QH_STCM		_EHCI_MAKEMASK(8,S_EHCI_QH_STCM)
#define V_EHCI_QH_STCM(x)	_EHCI_MAKEVALUE(x,S_EHCI_QH_STCM)
#define G_EHCI_QH_STCM(x)	_EHCI_GETVALUE(x,S_EHCI_QH_STCM,M_EHCI_QH_STCM)

#define S_EHCI_QH_STSM		0
#define M_EHCI_QH_STSM		_EHCI_MAKEMASK(8,S_EHCI_QH_STSM)
#define V_EHCI_QH_STSM(x)	_EHCI_MAKEVALUE(x,S_EHCI_QH_STSM)
#define G_EHCI_QH_STSM(x)	_EHCI_GETVALUE(x,S_EHCI_QH_STSM,M_EHCI_QH_STSM)
...
#define M_EHCI_QH_C		_EHCI_MAKEMASK1(27)
