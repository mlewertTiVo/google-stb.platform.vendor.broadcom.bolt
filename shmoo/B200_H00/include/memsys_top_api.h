...
Generation Date:    Fri May 20 12:17:14 EDT 2016

Generated By:       generate_top_api.pl 
Generator version:  2.6

Description:
  Memsys Library Public API for PHY rev F0 and MEMC rev B1p3 
...
#define MEMSYS_FW_VERSION_ENG               28
 ...
 *
 * get_time_us - Get global clock count in microsecond units. This timer must
 *     not roll-over for the duration of the execution of shmoo (under 2s).
...
typedef struct memsys_system_callbacks
{
    ...
    uint32_t (*get_time_us)(void);          // required
} memsys_system_callbacks_t;
...
typedef enum memsys_error_shmoo
{
    ...
    MEMSYS_ERROR_SHMOO_LP4_FAILED_RD_DLY_PATTERN,               // word 1: 0x00002000
    MEMSYS_ERROR_SHMOO_LP4_RD_DLY_NO_MIN_PASS_WINDOW,           // word 1: 0x00004000  
    MEMSYS_ERROR_SHMOO_LP4_RD_DLY_FAILED_REPORT,                // word 1: 0x00008000 
    MEMSYS_ERROR_SHMOO_UNUSED_1,                                // word 1: 0x00010000 
    MEMSYS_ERROR_SHMOO_UNUSED_2,                                // word 1: 0x00020000   
    MEMSYS_ERROR_SHMOO_UNUSED_3,                                // word 1: 0x00040000  
    MEMSYS_ERROR_SHMOO_UNUSED_4,                                // word 1: 0x00080000  
    MEMSYS_ERROR_SHMOO_UNUSED_5,                                // word 1: 0x00100000
    MEMSYS_ERROR_SHMOO_UNUSED_6,                                // word 1: 0x00200000
    MEMSYS_ERROR_SHMOO_UNUSED_7,                                // word 1: 0x00400000 
    MEMSYS_ERROR_SHMOO_UNUSED_8,                                // word 1: 0x00800000  
    MEMSYS_ERROR_SHMOO_UNUSED_9,                                // word 1: 0x01000000 
    MEMSYS_ERROR_SHMOO_UNUSED_10,                               // word 1: 0x02000000    
