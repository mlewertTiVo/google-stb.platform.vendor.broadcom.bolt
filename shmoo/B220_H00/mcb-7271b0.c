...
/* 7271B_1600MHz_32b_dev16Gx1_LPDDR4-3200_le.mcb
*/
...
static const uint32_t mcb_1600mhz_32b_dev16Gx1[] __attribute__ ((section(".mcbdata"))) = {
	0xffffffff,  0x6bfd0469,	/* -1 */
}; /* 0 difference */

/* 7271B_1600MHz_32b_dev8Gx2_LPDDR4-3200_le.mcb
*/
static const uint32_t mcb_1600mhz_32b_dev8Gx2[] __attribute__ ((section(".mcbdata"))) = {
	0x00000003,  0x4f5caa42,	/* 3 */
	0x00000005,  0x00002a02,	/* 5 */
	0x00000006,  0x00104989,	/* 6 */
	...
	0xffffffff,  0x9febfb73,	/* -1 */
}; /* 15 differences */

/* 7271B_1867MHz_32b_dev16Gx1_LPDDR4-3733_le.mcb
*/
static const uint32_t mcb_1867mhz_32b_dev16Gx1[] __attribute__ ((section(".mcbdata"))) = {
	0x00000003,  0x98cbb34c,	/* 3 */
	0x00000006,  0x00204b04,	/* 6 */
	...
	0xffffffff,  0x32ca0d87,	/* -1 */
}; /* 39 differences */

/* 7271B_1867MHz_32b_dev8Gx2_LPDDR4-3733_le.mcb
*/
static const uint32_t mcb_1867mhz_32b_dev8Gx2[] __attribute__ ((section(".mcbdata"))) = {
	0x00000003,  0xabc16e7d,	/* 3 */
	0x00000005,  0x00002a02,	/* 5 */
	0x00000006,  0x00204989,	/* 6 */
	0x0000000f,  0x0000074b,	/* 15 */
	0x00000010,  0x001c513f,	/* 16 */
	0x00000014,  0x00002000,	/* 20 */
	0x00000015,  0x00002000,	/* 21 */
