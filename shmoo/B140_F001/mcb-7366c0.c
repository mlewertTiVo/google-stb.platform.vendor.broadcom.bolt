...
static const uint32_t ddr4_1067mhz_32b_dev4Gx16[] __attribute__ ((section(".mcbdata"))) = {
	0x00000003,  0xb2a2ddb0,	/* 3 */
	0x00000006,  0x003036b9,	/* 6 */
