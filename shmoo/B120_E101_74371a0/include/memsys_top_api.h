...
Generation Date:    Tue Nov 25 11:36:39 EST 2014

Generated By:       generate_top_api.pl 
Generator version:  1.0

Description:
  Memsys Library Public API for PHY rev E1 and MEMC rev B1p2 
...
#define MEMSYS_FW_VERSION_ENG               6
...
typedef enum memsys_error_shmoo
{
    ...
    MEMSYS_ERROR_OVERALL_MCB_INVALID,
    MEMSYS_ERROR_OVERALL_MCB_BAD_CHECKSUM,
    MEMSYS_ERROR_OVERALL_PHY_MCB_INVALID,
    MEMSYS_ERROR_OVERALL_PHY_MCB_BAD_VERSION,
    MEMSYS_ERROR_OVERALL_MEMC_MCB_INVALID,
    MEMSYS_ERROR_OVERALL_MEMC_BAD_REG_BASE,
    MEMSYS_ERROR_OVERALL_MEMC_MCB_BAD_VERSION,
    MEMSYS_ERROR_PSSR_BIG_BIT_LENGTH,
    MEMSYS_ERROR_PSSR_NULL_PTR,
    MEMSYS_ERROR_PSSR_BAD_ALT_ID,
    MEMSYS_ERROR_PSSR_CHECKSUM,
    MEMSYS_ERROR_PSSR_GLOBAL_COUNTER,
    MEMSYS_ERROR_PSSR_UNEXPECTED_ALT_ENTRY,
    MEMSYS_ERROR_PSSR_UNEXPECTED_FUNC_INDEX,
    MEMSYS_ERROR_PSSR_MEMC_TIMEOUT_ON_WARM_BOOT,
    MEMSYS_ERROR_SHMOO_ZQCAL_NO_P_LOW,
    MEMSYS_ERROR_SHMOO_ZQCAL_NO_P_HIGH,
    MEMSYS_ERROR_SHMOO_ZQCAL_NO_N_LOW,              
    MEMSYS_ERROR_SHMOO_ZQCAL_NO_N_HIGH,             
    MEMSYS_ERROR_SHMOO_ZQCAL_NO_SOLUTION,           
    MEMSYS_ERROR_SHMOO_WR_LEVEL_TO_1,               
    MEMSYS_ERROR_SHMOO_WR_LEVEL_NOT_CONVERGED,
    MEMSYS_ERROR_SHMOO_READ_ENABLE_FAILED,          
    MEMSYS_ERROR_SHMOO_READ_ENABLE_MEM_TEST_FAILED, 
    MEMSYS_ERROR_SHMOO_READ_ENABLE_PEGGED_VDL,      
    MEMSYS_ERROR_SHMOO_RD_DQS_MEM_TEST_FAILED,      
    MEMSYS_ERROR_SHMOO_RD_DQS_NO_BYTE_PASS,         
    MEMSYS_ERROR_SHMOO_READ_DQS_PEGGED_VDL,         
    MEMSYS_ERROR_SHMOO_WR_DQS_DQ_0,                 
    MEMSYS_ERROR_SHMOO_WR_DQS_DQ_1,                 
    MEMSYS_ERROR_SHMOO_WR_DQS_DQ_2,                 
    MEMSYS_ERROR_SHMOO_WR_DQS_MEM_TEST_FAILED,      
    MEMSYS_ERROR_SHMOO_WR_DQS_PEGGED_VDL,           
    MEMSYS_ERROR_SHMOO_WR_DM_TO_0,                  
    MEMSYS_ERROR_SHMOO_WR_DM_TO_1,                  
    MEMSYS_ERROR_SHMOO_WR_DM_TO_2,                  
    MEMSYS_ERROR_SHMOO_WR_DM_TO_3,                  
    MEMSYS_ERROR_SHMOO_WR_DM_MEM_TEST_FAILED,       
    MEMSYS_ERROR_SHMOO_WR_DM_PEGGED_VDL,            
    MEMSYS_ERROR_SHMOO_PRINT_REPORT,                
    MEMSYS_ERROR_SHMOO_FILTER,                      
    MEMSYS_ERROR_SHMOO_ADDX_SHMOO_PEGGED_VDL,       
    MEMSYS_ERROR_SHMOO_ADDX_SHMOO_MEM_TEST_FAILED,
    MEMSYS_ERROR_SHMOO_CA_TRAINING_FAILED,
    MEMSYS_ERROR_SHMOO_GDDR5_ADDX_ALIGN_VDL_NOT_AT_CALIB,      
    MEMSYS_ERROR_SHMOO_GDDR5_ADDX_ALIGN_PEGGED_VDL,            
    MEMSYS_ERROR_SHMOO_GDDR5_VENDOR_ID_ERROR,                  
    MEMSYS_ERROR_SHMOO_GDDR5_WCK2CK_ALIGN_SAMPLE_TO,           
    MEMSYS_ERROR_SHMOO_GDDR5_ADDX_TRAIN_ERROR,                 
    MEMSYS_ERROR_SHMOO_GDDR5_WCK2CK_INVALID_INITIAL_STATE,     
    MEMSYS_ERROR_SHMOO_GDDR5_WCK2CK_ALIGN_FAIL_CONVERGE,       
    MEMSYS_ERROR_SHMOO_GDDR5_WCK2CK_ALIGN_PEGGED_VDL,          
    MEMSYS_ERROR_SHMOO_GDDR5_WCK2CK_FAILED_TO_DETECT_POLARITY, 
    MEMSYS_ERROR_SHMOO_GDDR5_RD_EN_SHMOO_NO_LEFT_WINDOW,       
    MEMSYS_ERROR_SHMOO_GDDR5_RD_EN_SHMOO_NO_RIGHT_WINDOW,      
    MEMSYS_ERROR_SHMOO_GDDR5_READ_ENABLE_SHMOO_PEGGED_VDL,     
    MEMSYS_ERROR_SHMOO_GDDR5_INVALID_MRE_OPTIONS,              
    MEMSYS_ERROR_SHMOO_HP_RX_TRIM_TO_ERROR,                    
    MEMSYS_ERROR_SHMOO_HP_RX_TRIM_NO_RESULT,                   
    MEMSYS_ERROR_SHMOO_HP_RX_TRIM_INVALID_DDR_TYPE,
    MEMSYS_ERROR_SHMOO_DDR4_ADDX_ALIGN_PEGGED_VDL,
    MEMSYS_ERROR_OVERALL_INCOMPATIBLE_FW_VERSION, 
    MEMSYS_ERROR_OVERALL_PARAM_INVALID,
    MEMSYS_ERROR_SHMOO_VTT_NOT_READY,
    MEMSYS_ERROR_FLOW_CONTROL_REGISTER_CALLBACKS,
    MEMSYS_ERROR_FLOW_CONTROL_MEMSYS_BEGIN,
    MEMSYS_ERROR_FLOW_CONTROL_PRE_MEMC_INIT,
    MEMSYS_ERROR_FLOW_CONTROL_PRE_SHMOO,
    MEMSYS_ERROR_FLOW_CONTROL_MEMSYS_END,
    MEMSYS_ERROR_SHMOO_DDR4_CS_SHMOO_PEGGED_VDL,
