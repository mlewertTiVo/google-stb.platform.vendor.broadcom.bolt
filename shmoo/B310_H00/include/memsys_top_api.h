...
Generation Date:    Sat Feb 10 13:14:15 EST 2018

Generated By:       generate_top_api.pl 
Generator version:  3.0

Description:
  Memsys Library Public API for PHY rev H0 and MEMC rev B3p1 
...
#define MEMSYS_FW_VERSION_MINOR             7
...
typedef enum memsys_error_shmoo
{
    ...
    MEMSYS_ERROR_OVERALL_MCB_SPD_INCOMPATIBLE,              // word 4: 0x00000040
    ...
    MEMSYS_ERROR_SHMOO_DB_RD_DQS_TRAINING_FAILED,           // word 4: 0x00010000
    MEMSYS_ERROR_SHMOO_DB_DRAM_WRITE_LEVELING_FAILED,       // word 4: 0x00020000
    MEMSYS_ERROR_SHMOO_DB_DRAM_WRITE_CYCLE_FAILED,          // word 4: 0x00040000
    MEMSYS_ERROR_SHMOO_FINAL_MEM_TEST_FAILED,               // word 4: 0x00080000
