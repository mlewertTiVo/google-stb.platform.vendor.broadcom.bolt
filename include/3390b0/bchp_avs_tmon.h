 ...
 ***************************************************************************/
#define BCHP_AVS_TMON_TEMPERATURE_MEASUREMENT_STATUS 0x20431500 /* [RO] Indicate temperature measurement data and validity of data */
#define BCHP_AVS_TMON_ENABLE_OVER_TEMPERATURE_RESET 0x20431504 /* [RW] Enable over temperature reset */
#define BCHP_AVS_TMON_TEMPERATURE_RESET_THRESHOLD 0x20431508 /* [RW] Represent threshold for over temperature reset */
#define BCHP_AVS_TMON_TEMPERATURE_INTERRUPT_IDLE_TIME 0x20431510 /* [RW] No new temperature interrupt can be generated for interval defined by this idle time */
#define BCHP_AVS_TMON_ENABLE_TEMPERATURE_INTERRUPT_SOURCES 0x20431514 /* [RW] Enable high and low temperature interrupts */
#define BCHP_AVS_TMON_TEMPERATURE_INTERRUPT_THRESHOLDS 0x20431518 /* [RW] Represent thresholds for high and low temperature interrupts */
#define BCHP_AVS_TMON_TEMPERATURE_INTERRUPT_TEMPERATURE 0x2043151c /* [RO] Temperature code associated with temperature interrupt event */
#define BCHP_AVS_TMON_TP_TMON_TEST_ENABLE        0x20431520 /* [RW] Enabling TP mode to use data from tp_in for testing TMON */
#define BCHP_AVS_TMON_SPARE_0                    0x20431524 /* [RW] Spare register 0 for AVS TEMPERATURE MONITOR core */
