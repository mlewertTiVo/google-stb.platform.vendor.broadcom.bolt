 ...
 ***************************************************************************/
#define BCHP_SHIMPHY_ADDR_CNTL_0_CONFIG          0x21108000 /* [CFG] SHIMPHY Config register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_SHIMPHY_REV_ID  0x21108004 /* [RO] SHIMPHY Revision ID Register. */
#define BCHP_SHIMPHY_ADDR_CNTL_0_RESET           0x21108008 /* [RW] DDR soft reset register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_CMD_DATA_FIFO   0x21108028 /* [RO] Command and Data FIFO Status Register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_RD_DATAPATH     0x2110802c /* [RO] Read Datapath Status Register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_FLAG_BUS        0x21108030 /* [RO] TP_OUT bus value Register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_MISC            0x21108034 /* [CFG] Miscellaneous Register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_DFI_CONTROL     0x21108038 /* [CFG] DFI Interface Control Register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_DFI_STATUS      0x2110803c /* [RO] DFI Interface Status Register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_PHY_LPM_STAT    0x21108040 /* [RO] PHY Power Control Status Register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_ALERT_STATUS    0x21108044 /* [RW] DDR4 Alert Status Register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_IDLE_POWER_SAVING 0x21108048 /* [CFG] DDR PHY Idle power saving Control register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_DDR_PAD_CNTRL   0x2110808c /* [CFG] DDR Pad control register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_SHIMPHY_STATUS  0x2110809c /* [RO] SHIMPHY Status Register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_SPARE0_RW       0x211080a4 /* [CFG] Spare register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_SPARE1_RW       0x211080a8 /* [CFG] Spare register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_SPARE0_RO       0x211080ac /* [RO] Spare register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_SPARE1_RO       0x211080b0 /* [RO] Spare register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_DDR3_RESET_CNTRL 0x211080b4 /* [CFG] FORCE_DDR3_RESET Deassert  Register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_SHIMPHY_FIFO_ERROR 0x211080b8 /* [RW] Shimphy FIFO Error Status Register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_SHIMPHY_PHY_GPIO 0x211080bc /* [RW] PHY GPIO Control and Status Register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_SHIMPHY_POSTSEQ_DELAY1 0x211080c0 /* [CFG] Post PHY pin Sequence Delay Register 1 */
#define BCHP_SHIMPHY_ADDR_CNTL_0_SHIMPHY_POSTSEQ_DELAY2 0x211080c4 /* [CFG] Post PHY pin Sequence Delay Register 2 */
