 ...
 *SWITCH_REG
 ***************************************************************************/
#define BCHP_SWITCH_REG_SWITCH_CNTRL             0x0000f80000 /* [RW][32] Switch Control Register */
#define BCHP_SWITCH_REG_SWITCH_STATUS            0x0000f80004 /* [RO][32] Switch Status Register */
#define BCHP_SWITCH_REG_DIR_DATA_WRITE_REG       0x0000f80008 /* [RW][32] Direct Data Write Register */
#define BCHP_SWITCH_REG_DIR_DATA_READ_REG        0x0000f8000c /* [RO][32] Direct Data Read Register */
#define BCHP_SWITCH_REG_SWITCH_REVISION          0x0000f80010 /* [RO][32] SWITCH Revision Control Register */
#define BCHP_SWITCH_REG_PHY_REVISION             0x0000f80014 /* [RO][32] PHY Revision Control Register */
#define BCHP_SWITCH_REG_PHY_TEST_CNTRL           0x0000f80018 /* [RW][32] PHY Test Control Register */
#define BCHP_SWITCH_REG_SPHY_CNTRL               0x0000f80024 /* [RW][32] Single GPHY Control Register */
#define BCHP_SWITCH_REG_SPHY_STATUS              0x0000f80028 /* [RO][32] Single GPHY Status Register */
#define BCHP_SWITCH_REG_SWITCH_PHY_INTR_CNTRL    0x0000f8002c /* [RW][32] Switch PHY Interrupt Control Register */
#define BCHP_SWITCH_REG_LED_0_CNTRL              0x0000f80040 /* [RW][32] LED Port 0 Control Register */
#define BCHP_SWITCH_REG_LED_0_LINK_AND_SPEED_ENCODING_SEL 0x0000f80044 /* [RW][32] LED Port 0 Link And Speed Encoding Selection Register */
#define BCHP_SWITCH_REG_LED_0_LINK_AND_SPEED_ENCODING 0x0000f80048 /* [RW][32] LED Port 0 Link And Speed Encoding Register */
#define BCHP_SWITCH_REG_LED_1_CNTRL              0x0000f8004c /* [RW][32] LED Port 1 Control Register */
#define BCHP_SWITCH_REG_LED_1_LINK_AND_SPEED_ENCODING_SEL 0x0000f80050 /* [RW][32] LED Port 1 Link And Speed Encoding Selection Register */
#define BCHP_SWITCH_REG_LED_1_LINK_AND_SPEED_ENCODING 0x0000f80054 /* [RW][32] LED Port 1 Link And Speed Encoding Register */
#define BCHP_SWITCH_REG_LED_2_CNTRL              0x0000f80058 /* [RW][32] LED Port 2 Control Register */
#define BCHP_SWITCH_REG_LED_2_LINK_AND_SPEED_ENCODING_SEL 0x0000f8005c /* [RW][32] LED Port 2 Link And Speed Encoding Selection Register */
#define BCHP_SWITCH_REG_LED_2_LINK_AND_SPEED_ENCODING 0x0000f80060 /* [RW][32] LED Port 2 Link And Speed Encoding Register */
#define BCHP_SWITCH_REG_LED_BLINK_RATE_CNTRL     0x0000f800ac /* [RW][32] LED port Blink Rate Control Register */
#define BCHP_SWITCH_REG_LED_SERIAL_CNTRL         0x0000f800b0 /* [RW][32] LED Serial Control Register */
#define BCHP_SWITCH_REG_REFRESH_PERIOD_CNTRL     0x0000f800b4 /* [RW][32] LED Refresh Period Control Register */
#define BCHP_SWITCH_REG_AGGREGATE_LED_CNTRL      0x0000f800b8 /* [RW][32] Aggregate LED Control Register */
#define BCHP_SWITCH_REG_AGGREGATE_LED_BLINK_RATE_CNTRL 0x0000f800bc /* [RW][32] Aggregate LED Blink Rate Control Register */
#define BCHP_SWITCH_REG_RGMII_1_CNTRL            0x0000f800ec /* [RW][32] RGMII port 1 Control Register */
#define BCHP_SWITCH_REG_RGMII_1_IB_STATUS        0x0000f800f0 /* [RW][32] RGMII port 1 InBand Status Register */
#define BCHP_SWITCH_REG_RGMII_1_RX_CLOCK_DELAY_CNTRL 0x0000f800f4 /* [RW][32] RGMII port 1 RX Clock Delay Control Register */
#define BCHP_SWITCH_REG_RGMII_2_CNTRL            0x0000f800f8 /* [RW][32] RGMII port 2 Control Register */
#define BCHP_SWITCH_REG_RGMII_2_IB_STATUS        0x0000f800fc /* [RW][32] RGMII port 2 InBand Status Register */
#define BCHP_SWITCH_REG_RGMII_2_RX_CLOCK_DELAY_CNTRL 0x0000f80100 /* [RW][32] RGMII port 2 RX Clock Delay Control Register */
#define BCHP_SWITCH_REG_RGMII_1_ATE_RX_CNTRL_EXP_DATA 0x0000f80184 /* [RW][32] RGMII port 1 ATE RX Control and Expected Data Register */
#define BCHP_SWITCH_REG_RGMII_1_ATE_RX_EXP_DATA_1 0x0000f80188 /* [RW][32] RGMII port 1 ATE RX Expected Data 1 Register */
#define BCHP_SWITCH_REG_RGMII_1_ATE_RX_STATUS_0  0x0000f8018c /* [RO][32] RGMII port 1 ATE RX Status 0 Register */
#define BCHP_SWITCH_REG_RGMII_1_ATE_RX_STATUS_1  0x0000f80190 /* [RO][32] RGMII port 1 ATE RX Status 1 Register */
#define BCHP_SWITCH_REG_RGMII_1_ATE_TX_CNTRL     0x0000f80194 /* [RW][32] RGMII port 1 ATE TX Control Register */
#define BCHP_SWITCH_REG_RGMII_1_ATE_TX_DATA_0    0x0000f80198 /* [RW][32] RGMII port 1 ATE TX Data 0 Register */
#define BCHP_SWITCH_REG_RGMII_1_ATE_TX_DATA_1    0x0000f8019c /* [RW][32] RGMII port 1 ATE TX Data 1 Register */
#define BCHP_SWITCH_REG_RGMII_1_ATE_TX_DATA_2    0x0000f801a0 /* [RW][32] RGMII port 1 ATE TX Data 2 Register */
#define BCHP_SWITCH_REG_RGMII_2_ATE_RX_CNTRL_EXP_DATA 0x0000f801a4 /* [RW][32] RGMII port 2 ATE RX Control and Expected Data Register */
#define BCHP_SWITCH_REG_RGMII_2_ATE_RX_EXP_DATA_1 0x0000f801a8 /* [RW][32] RGMII port 2 ATE RX Expected Data 1 Register */
#define BCHP_SWITCH_REG_RGMII_2_ATE_RX_STATUS_0  0x0000f801ac /* [RO][32] RGMII port 2 ATE RX Status 0 Register */
#define BCHP_SWITCH_REG_RGMII_2_ATE_RX_STATUS_1  0x0000f801b0 /* [RO][32] RGMII port 2 ATE RX Status 1 Register */
#define BCHP_SWITCH_REG_RGMII_2_ATE_TX_CNTRL     0x0000f801b4 /* [RW][32] RGMII port 2 ATE TX Control Register */
#define BCHP_SWITCH_REG_RGMII_2_ATE_TX_DATA_0    0x0000f801b8 /* [RW][32] RGMII port 2 ATE TX Data 0 Register */
#define BCHP_SWITCH_REG_RGMII_2_ATE_TX_DATA_1    0x0000f801bc /* [RW][32] RGMII port 2 ATE TX Data 1 Register */
#define BCHP_SWITCH_REG_RGMII_2_ATE_TX_DATA_2    0x0000f801c0 /* [RW][32] RGMII port 2 ATE TX Data 2 Register */
#define BCHP_SWITCH_REG_RGMII_1_TX_DELAY_CNTRL_0 0x0000f802d8 /* [RW][32] RGMII Append 1 TX Delay Control 0 Register */
#define BCHP_SWITCH_REG_RGMII_1_TX_DELAY_CNTRL_1 0x0000f802dc /* [RW][32] RGMII Append 1 TX Delay Control 1 Register */
#define BCHP_SWITCH_REG_RGMII_1_RX_DELAY_CNTRL_0 0x0000f802e0 /* [RW][32] RGMII Append 1 RX Delay Control 0 Register */
#define BCHP_SWITCH_REG_RGMII_1_RX_DELAY_CNTRL_1 0x0000f802e4 /* [RW][32] RGMII Append 1 RX Delay Control 1 Register */
#define BCHP_SWITCH_REG_RGMII_1_RX_DELAY_CNTRL_2 0x0000f802e8 /* [RW][32] RGMII Append 1 RX Delay Control 2 Register */
#define BCHP_SWITCH_REG_RGMII_2_TX_DELAY_CNTRL_0 0x0000f802ec /* [RW][32] RGMII Append 2 TX Delay Control 0 Register */
#define BCHP_SWITCH_REG_RGMII_2_TX_DELAY_CNTRL_1 0x0000f802f0 /* [RW][32] RGMII Append 2 TX Delay Control 1 Register */
#define BCHP_SWITCH_REG_RGMII_2_RX_DELAY_CNTRL_0 0x0000f802f4 /* [RW][32] RGMII Append 2 RX Delay Control 0 Register */
#define BCHP_SWITCH_REG_RGMII_2_RX_DELAY_CNTRL_1 0x0000f802f8 /* [RW][32] RGMII Append 2 RX Delay Control 1 Register */
#define BCHP_SWITCH_REG_RGMII_2_RX_DELAY_CNTRL_2 0x0000f802fc /* [RW][32] RGMII Append 2 RX Delay Control 2 Register */
#define BCHP_SWITCH_REG_SPARE_CNTRL              0x0000f803f0 /* [RW][32] Spare Control Register */
...
#define BCHP_SWITCH_REG_SWITCH_REVISION_SF2_rev_DEFAULT            0x00000408
...
#define BCHP_SWITCH_REG_SWITCH_REVISION_switch_top_rev_DEFAULT     0x00000408
 ...
 ***************************************************************************/
/* SWITCH_REG :: RGMII_1_CNTRL :: reserved0 [31:17] */
#define BCHP_SWITCH_REG_RGMII_1_CNTRL_reserved0_MASK               0xfffe0000
#define BCHP_SWITCH_REG_RGMII_1_CNTRL_reserved0_SHIFT              17

/* SWITCH_REG :: RGMII_1_CNTRL :: pseudo_hd_mode_en [16:16] */
#define BCHP_SWITCH_REG_RGMII_1_CNTRL_pseudo_hd_mode_en_MASK       0x00010000
#define BCHP_SWITCH_REG_RGMII_1_CNTRL_pseudo_hd_mode_en_SHIFT      16
#define BCHP_SWITCH_REG_RGMII_1_CNTRL_pseudo_hd_mode_en_DEFAULT    0x00000000
 ...
 ***************************************************************************/
/* SWITCH_REG :: RGMII_2_CNTRL :: reserved0 [31:17] */
#define BCHP_SWITCH_REG_RGMII_2_CNTRL_reserved0_MASK               0xfffe0000
#define BCHP_SWITCH_REG_RGMII_2_CNTRL_reserved0_SHIFT              17

/* SWITCH_REG :: RGMII_2_CNTRL :: pseudo_hd_mode_en [16:16] */
#define BCHP_SWITCH_REG_RGMII_2_CNTRL_pseudo_hd_mode_en_MASK       0x00010000
#define BCHP_SWITCH_REG_RGMII_2_CNTRL_pseudo_hd_mode_en_SHIFT      16
#define BCHP_SWITCH_REG_RGMII_2_CNTRL_pseudo_hd_mode_en_DEFAULT    0x00000000
