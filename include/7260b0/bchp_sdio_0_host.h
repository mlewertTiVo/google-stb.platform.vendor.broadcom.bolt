 ...
 ***************************************************************************/
#define BCHP_SDIO_0_HOST_SDMA                    0x0020200000 /* [RW][32] System DMA Address Register */
#define BCHP_SDIO_0_HOST_BLOCK                   0x0020200004 /* [RW][32] Block Reset and Count Register */
#define BCHP_SDIO_0_HOST_ARGUMENT                0x0020200008 /* [RW][32] Argument Register */
#define BCHP_SDIO_0_HOST_CMD_MODE                0x002020000c /* [RW][32] Command and Mode Register */
#define BCHP_SDIO_0_HOST_RESP_01                 0x0020200010 /* [RO][32] Response Word 0 and 1 */
#define BCHP_SDIO_0_HOST_RESP_23                 0x0020200014 /* [RO][32] Response Word 2 and 3 */
#define BCHP_SDIO_0_HOST_RESP_45                 0x0020200018 /* [RO][32] Response Word 4 and 5 */
#define BCHP_SDIO_0_HOST_RESP_67                 0x002020001c /* [RO][32] Response Word 6 and 7 */
#define BCHP_SDIO_0_HOST_BUFFDATA                0x0020200020 /* [RW][32] Buffer Data Port for PIO Tranfers */
#define BCHP_SDIO_0_HOST_STATE                   0x0020200024 /* [RO][32] Present State of Controller */
#define BCHP_SDIO_0_HOST_CTRL_SET0               0x0020200028 /* [RW][32] SD Standard Control Registers for Host, Power, BlockGap, WakeUp */
#define BCHP_SDIO_0_HOST_CTRL_SET1               0x002020002c /* [RW][32] SD Standard Control Registers for Clock, Timeout, Resets */
#define BCHP_SDIO_0_HOST_INT_STATUS              0x0020200030 /* [RW][32] Interrupt Status for Normal and Error conditions */
#define BCHP_SDIO_0_HOST_INT_STATUS_ENA          0x0020200034 /* [RW][32] Interrupt Enables for Normal and Error conditions */
#define BCHP_SDIO_0_HOST_INT_SIGNAL_ENA          0x0020200038 /* [RW][32] Interrupt Signal Enables for Normal and Error conditions */
#define BCHP_SDIO_0_HOST_AUTOCMD12_STAT          0x002020003c /* [RW][32] Auto Cmd12 Error Status */
#define BCHP_SDIO_0_HOST_CAPABLE                 0x0020200040 /* [RO][32] Host Controller Capabilities to Software */
#define BCHP_SDIO_0_HOST_CAPABLE_1               0x0020200044 /* [RO][32] Future Host Controller Capabilities to Software */
#define BCHP_SDIO_0_HOST_POWER_CAPABLE           0x0020200048 /* [RO][32] Host Controller Power Capabilities to Software */
#define BCHP_SDIO_0_HOST_POWER_CAPABLE_RSVD      0x002020004c /* [RO][32] Future Host Controller Power Capabilities to Software */
#define BCHP_SDIO_0_HOST_FORCE_EVENTS            0x0020200050 /* [RW][32] Force Events on Error Status Bits */
#define BCHP_SDIO_0_HOST_ADMA_ERR_STAT           0x0020200054 /* [RO][32] ADMA Error Status Bits */
#define BCHP_SDIO_0_HOST_ADMA_SYSADDR_LO         0x0020200058 /* [RW][32] ADMA System Address Low Bits */
#define BCHP_SDIO_0_HOST_ADMA_SYSADDR_HI         0x002020005c /* [RO][32] ADMA System Address High Bits */
#define BCHP_SDIO_0_HOST_PRESET_INIT_DEFAULT     0x0020200060 /* [RO][32] Preset Values for init and default speed */
#define BCHP_SDIO_0_HOST_PRESET_HIGH_SPEED       0x0020200064 /* [RO][32] Preset Values for high speed and SDR12 */
#define BCHP_SDIO_0_HOST_PRESET_SDR25_50         0x0020200068 /* [RO][32] Preset Values for SDR25 and SDR50 */
#define BCHP_SDIO_0_HOST_PRESET_SDR104_DDR50     0x002020006c /* [RO][32] Preset Values for SDR104 and DDR50 */
#define BCHP_SDIO_0_HOST_BOOT_TIMEOUT            0x0020200070 /* [RW][32] DAT line inactivity timeout on boot */
#define BCHP_SDIO_0_HOST_DEBUG_SELECT            0x0020200074 /* [WO][32] Debug probe output selection */
#define BCHP_SDIO_0_HOST_SHARED_BUS_CTRL         0x00202000e0 /* [RW][32] shared bus control */
#define BCHP_SDIO_0_HOST_SPI_INTERRUPT           0x00202000f0 /* [RW][32] SPI Interrupt support */
#define BCHP_SDIO_0_HOST_VERSION_STATUS          0x00202000fc /* [RO][32] Controller Version and Slot Status */
