 ...
 ***************************************************************************/
#define BCHP_XPT_WDMA_CH0_FIRST_DESC_ADDR        0x0020a6a000 /* [RW][32] First Descriptor Address */
#define BCHP_XPT_WDMA_CH0_NEXT_DESC_ADDR         0x0020a6a004 /* [RW][32] Next Descriptor Address */
#define BCHP_XPT_WDMA_CH0_COMPLETED_DESC_ADDRESS 0x0020a6a008 /* [RW][32] Completed Descriptor Address */
#define BCHP_XPT_WDMA_CH0_BTP_PACKET_GROUP_ID    0x0020a6a00c /* [RW][32] Packet Group ID reported per BTP command */
#define BCHP_XPT_WDMA_CH0_RUN_VERSION_CONFIG     0x0020a6a010 /* [RW][32] RUN_VERSION configuration */
#define BCHP_XPT_WDMA_CH0_OVERFLOW_REASONS       0x0020a6a014 /* [RW][32] Overflow Reason */
#define BCHP_XPT_WDMA_CH0_DMQ_CONTROL_STRUCT     0x0020a6a018 /* [RO][32] Descriptor Memory Queue Control Structure */
#define BCHP_XPT_WDMA_CH0_DATA_CONTROL           0x0020a6a01c /* [RW][32] Data Control */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_BASE_PTR_HI  0x0020a6a080 /* [RW][32] DRAM Buffer Base Pointer - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_BASE_PTR     0x0020a6a084 /* [RW][32] DRAM Buffer Base Pointer - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_END_PTR_HI   0x0020a6a088 /* [RW][32] DRAM Buffer End Pointer - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_END_PTR      0x0020a6a08c /* [RW][32] DRAM Buffer End Pointer - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_RD_PTR_HI    0x0020a6a090 /* [RW][32] DRAM Buffer Read Pointer - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_RD_PTR       0x0020a6a094 /* [RW][32] DRAM Buffer Read Pointer - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_WR_PTR_HI    0x0020a6a098 /* [RW][32] DRAM Buffer Write Pointer - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_WR_PTR       0x0020a6a09c /* [RW][32] DRAM Buffer Write Pointer - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_VALID_PTR_HI 0x0020a6a0a0 /* [RW][32] DRAM Buffer Valid Pointer - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_VALID_PTR    0x0020a6a0a4 /* [RW][32] DRAM Buffer Valid Pointer - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_LOWER_THRESHOLD_HI 0x0020a6a0a8 /* [RW][32] DRAM Buffer Lower Threshold - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_LOWER_THRESHOLD 0x0020a6a0ac /* [RW][32] DRAM Buffer Lower Threshold - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_UPPER_THRESHOLD_HI 0x0020a6a0b0 /* [RW][32] DRAM Buffer Upper Threshold - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_UPPER_THRESHOLD 0x0020a6a0b4 /* [RW][32] DRAM Buffer Upper Threshold - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_STATUS       0x0020a6a0b8 /* [RW][32] DRAM Buffer Status */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_CONTROL      0x0020a6a0bc /* [RW][32] DRAM Buffer Control */
#define BCHP_XPT_WDMA_CH0_DMQ_0_0                0x0020a6a0c0 /* [RW][32] DMQ descriptor 0 - Write Address, Upper bits */
#define BCHP_XPT_WDMA_CH0_DMQ_0_1                0x0020a6a0c4 /* [RW][32] DMQ descriptor 0 - Write Address, lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DMQ_0_2                0x0020a6a0c8 /* [RW][32] DMQ descriptor 0 - Transfer Size */
#define BCHP_XPT_WDMA_CH0_DMQ_0_3                0x0020a6a0cc /* [RW][32] DMQ descriptor 0 - Current Descriptor Address and Control */
#define BCHP_XPT_WDMA_CH0_DMQ_1_0                0x0020a6a0d0 /* [RW][32] DMQ descriptor 1 - Write Address, Upper bits */
#define BCHP_XPT_WDMA_CH0_DMQ_1_1                0x0020a6a0d4 /* [RW][32] DMQ descriptor 1 - Write Address, lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DMQ_1_2                0x0020a6a0d8 /* [RW][32] DMQ descriptor 1 - Transfer Size */
#define BCHP_XPT_WDMA_CH0_DMQ_1_3                0x0020a6a0dc /* [RW][32] DMQ descriptor 1 - Current Descriptor Address and Control */
#define BCHP_XPT_WDMA_CH0_DMQ_2_0                0x0020a6a0e0 /* [RW][32] DMQ descriptor 2 - Write Address, Upper bits */
#define BCHP_XPT_WDMA_CH0_DMQ_2_1                0x0020a6a0e4 /* [RW][32] DMQ descriptor 2 - Write Address, lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DMQ_2_2                0x0020a6a0e8 /* [RW][32] DMQ descriptor 2 - Transfer Size */
#define BCHP_XPT_WDMA_CH0_DMQ_2_3                0x0020a6a0ec /* [RW][32] DMQ descriptor 2 - Current Descriptor Address and Control */
#define BCHP_XPT_WDMA_CH0_DMQ_3_0                0x0020a6a0f0 /* [RW][32] DMQ descriptor 3 - Write Address, Upper bits */
#define BCHP_XPT_WDMA_CH0_DMQ_3_1                0x0020a6a0f4 /* [RW][32] DMQ descriptor 3 - Write Address, lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DMQ_3_2                0x0020a6a0f8 /* [RW][32] DMQ descriptor 3 - Transfer Size */
#define BCHP_XPT_WDMA_CH0_DMQ_3_3                0x0020a6a0fc /* [RW][32] DMQ descriptor 3 - Current Descriptor Address and Control */
