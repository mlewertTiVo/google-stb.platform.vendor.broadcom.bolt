 ...
 *V3D_HUB_CTL
 ***************************************************************************/
#define BCHP_V3D_HUB_CTL_AXICFG                  0x0021300000 /* [RW][32] AXI configuration */
#define BCHP_V3D_HUB_CTL_UIFCFG                  0x0021300004 /* [RW][32] UIF configuration */
#define BCHP_V3D_HUB_CTL_IDENT0                  0x0021300008 /* [RO][32] V3D Hub Identification 0 (V3D hub block identity) */
#define BCHP_V3D_HUB_CTL_IDENT1                  0x002130000c /* [RO][32] V3D Hub Identification 1 (V3D Hub Configuration A) */
#define BCHP_V3D_HUB_CTL_IDENT2                  0x0021300010 /* [RO][32] V3D Hub Identification 1 (V3D Hub Configuration B) */
#define BCHP_V3D_HUB_CTL_IDENT3                  0x0021300014 /* [RO][32] V3D Hub Identification 3 */
#define BCHP_V3D_HUB_CTL_FPGACFG                 0x0021300040 /* [RW][32] (FPGA-ONLY) V3D Hub FPGA dummy slave configuration */
#define BCHP_V3D_HUB_CTL_FPGACFG1                0x0021300044 /* [RW][32] (FPGA-ONLY) V3D Hub FPGA dummy slave configuration 1 */
#define BCHP_V3D_HUB_CTL_INT_STS                 0x0021300050 /* [RO][32] V3D Interrupt Status */
#define BCHP_V3D_HUB_CTL_INT_SET                 0x0021300054 /* [WO][32] V3D Interrupt Set */
#define BCHP_V3D_HUB_CTL_INT_CLR                 0x0021300058 /* [WO][32] V3D Interrupt Clear */
#define BCHP_V3D_HUB_CTL_INT_MSK_STS             0x002130005c /* [RO][32] V3D Interrupt Mask Status */
#define BCHP_V3D_HUB_CTL_INT_MSK_SET             0x0021300060 /* [WO][32] V3D Interrupt Mask Set */
#define BCHP_V3D_HUB_CTL_INT_MSK_CLR             0x0021300064 /* [WO][32] V3D Interrupt Mask Clear */
#define BCHP_V3D_HUB_CTL_INT_STS_PCI             0x0021300068 /* [RO][32] Duplicate V3D Interrupt Status, reads 0 when BCG_INT in IDENT2 is 0 */
#define BCHP_V3D_HUB_CTL_INT_SET_PCI             0x002130006c /* [WO][32] Duplicate V3D Interrupt Set, write has no effect when BCG_INT in IDENT2 is 0 */
#define BCHP_V3D_HUB_CTL_INT_CLR_PCI             0x0021300070 /* [WO][32] Duplicate V3D Interrupt Clear, write has no effect when BCG_INT in IDENT2 is 0 */
#define BCHP_V3D_HUB_CTL_INT_MSK_STS_PCI         0x0021300074 /* [RO][32] Duplicate V3D Interrupt Mask Status, reads 0 when BCG_INT in IDENT2 is 0 */
#define BCHP_V3D_HUB_CTL_INT_MSK_SET_PCI         0x0021300078 /* [WO][32] Duplicate V3D Interrupt Mask Set, write has no effect when BCG_INT in IDENT2 is 0 */
#define BCHP_V3D_HUB_CTL_INT_MSK_CLR_PCI         0x002130007c /* [WO][32] Duplicate V3D Interrupt Mask Clear, write has noeffect when BCG_INT in IDENT2 is 0 */
