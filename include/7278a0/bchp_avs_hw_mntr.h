 ...
 *
 * Date:           Generated on               Thu Dec  1 06:45:57 2016
 ...
 ***************************************************************************/
#define BCHP_AVS_HW_MNTR_SW_CONTROLS             0x00152000 /* [RW][32] Software control command registers for AVS */
#define BCHP_AVS_HW_MNTR_SW_MEASUREMENT_UNIT_BUSY 0x00152004 /* [RO][32] Indicate measurement unit is busy and SW should not de-assert sw_takeover while this is asserted */
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_PVT_MNTR 0x00152008 /* [RW][32] Software to reset the pvt monitors measurements' valid bits in RO registers */
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_CEN_ROSC_0 0x0015200c /* [RW][32] Software to reset the central roscs measurements' valid bits in RO registers */
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_CEN_ROSC_1 0x00152010 /* [RW][32] Software to reset the central roscs measurements' valid bits in RO registers */
#define BCHP_AVS_HW_MNTR_MEASUREMENTS_INIT_POW_WDOG 0x00152034 /* [RW][32] Software to reset the power watchdog measurment's valid bits in RO registers */
#define BCHP_AVS_HW_MNTR_SEQUENCER_INIT          0x00152038 /* [RW][32] Initialize the sensor sequencer */
#define BCHP_AVS_HW_MNTR_SEQUENCER_MASK_PVT_MNTR 0x0015203c /* [RW][32] Indicate which PVT Monitor measurements should  be masked(skipped) in the measurement sequence */
#define BCHP_AVS_HW_MNTR_SEQUENCER_MASK_CEN_ROSC_0 0x00152040 /* [RW][32] Indicate which central ring oscillators should  be masked(skipped) in the measurement sequence */
#define BCHP_AVS_HW_MNTR_SEQUENCER_MASK_CEN_ROSC_1 0x00152044 /* [RW][32] Indicate which central ring oscillators should  be masked(skipped) in the measurement sequence */
#define BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_PVT_MNTR 0x00152068 /* [RW][32] Enabling/Disabling PVT monitor */
#define BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_CEN_ROSC_0 0x0015206c /* [RW][32] Enabling/Disabling of central ring oscillators */
#define BCHP_AVS_HW_MNTR_ENABLE_DEFAULT_CEN_ROSC_1 0x00152070 /* [RW][32] Enabling/Disabling of central ring oscillators */
#define BCHP_AVS_HW_MNTR_ROSC_MEASUREMENT_TIME_CONTROL 0x00152074 /* [RW][32] Control the time taken for a rosc/pwd measurement */
#define BCHP_AVS_HW_MNTR_ROSC_COUNTING_MODE      0x00152078 /* [RW][32] Control the counting event for rosc signal counter */
#define BCHP_AVS_HW_MNTR_INTERRUPT_POW_WDOG_EN   0x0015207c /* [RW][32] Software to program a mask(1 bit per PWD) to indicate which PWD signals may trigger an interrupt */
#define BCHP_AVS_HW_MNTR_INTERRUPT_POW_WDOG_EN_1 0x00152080 /* [RW][32] Software to program a mask(1 bit per PWD) to indicate which PWD signals may trigger an interrupt */
#define BCHP_AVS_HW_MNTR_INTERRUPT_POW_WDOG_EN_2 0x00152084 /* [RW][32] Software to program a mask(1 bit per PWD) to indicate which PWD signals may trigger an interrupt */
#define BCHP_AVS_HW_MNTR_INTERRUPT_POW_WDOG_EN_3 0x00152088 /* [RW][32] Software to program a mask(1 bit per PWD) to indicate which PWD signals may trigger an interrupt */
#define BCHP_AVS_HW_MNTR_INTERRUPT_SW_MEASUREMENT_DONE_EN 0x0015208c /* [RW][32] Enable to trigger an interrupt when the measurement is done */
#define BCHP_AVS_HW_MNTR_LAST_MEASURED_SENSOR    0x00152090 /* [RO][32] The last sensor that has been measured */
#define BCHP_AVS_HW_MNTR_AVS_INTERRUPT_FLAGS     0x00152094 /* [RO][32] Indicate AVS interrupts status whether they are triggered or not */
#define BCHP_AVS_HW_MNTR_AVS_INTERRUPT_FLAGS_CLEAR 0x00152098 /* [RW][32] Software to clear the respective AVS interrupt flags */
#define BCHP_AVS_HW_MNTR_AVS_REGISTERS_LOCKS     0x001520ac /* [RW][32] To lock read/write accesses to AVS sensors and regulators registers for security purpose */
#define BCHP_AVS_HW_MNTR_TEMPERATURE_RESET_ENABLE 0x001520b0 /* [RW][32] Software to enable chip's temperature monitoring and temperature reset */
#define BCHP_AVS_HW_MNTR_TEMPERATURE_THRESHOLD   0x001520b4 /* [RW][32] Threshold value for chip's temperature monitoring */
#define BCHP_AVS_HW_MNTR_IDLE_STATE_0_CEN_ROSC_0 0x001520b8 /* [RW][32] Set the output value of ring oscillators when not enabled. */
#define BCHP_AVS_HW_MNTR_IDLE_STATE_0_CEN_ROSC_1 0x001520bc /* [RW][32] Set the output value of ring oscillators when not enabled. */
#define BCHP_AVS_HW_MNTR_ADC_SETTLING_TIME       0x001520c0 /* [RW][32] Define the number of samples output by ADC to skip following the change in ADC source select */
#define BCHP_AVS_HW_MNTR_AVS_SPARE_0             0x001520c4 /* [RW][32] Spare register 0 for AVS HW MONITOR core */
#define BCHP_AVS_HW_MNTR_AVS_SPARE_1             0x001520c8 /* [RW][32] Spare register 1 for AVS HW MONITOR core */
