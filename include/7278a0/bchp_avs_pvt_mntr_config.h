 ...
 ***************************************************************************/
#define BCHP_AVS_PVT_MNTR_CONFIG_PVT_MNTR_CTRL   0x00152100 /* [RW][32] Control bits for PVT monitor */
#define BCHP_AVS_PVT_MNTR_CONFIG_PVT_MNTR_TP_MODE_ENABLE 0x00152108 /* [RW][32] Enabling TP mode to use data from tp_in/out pins */
#define BCHP_AVS_PVT_MNTR_CONFIG_DAC_CODE_PROGRAMMING_ENABLE 0x00152110 /* [RW][32] SW must set this bit to 1 to modify DAC_CODE, MIN_DAC_CODE and MAX_DAC_CODE */
#define BCHP_AVS_PVT_MNTR_CONFIG_DAC_CODE        0x00152114 /* [RW][32] Represents the input code of the DAC */
#define BCHP_AVS_PVT_MNTR_CONFIG_MIN_DAC_CODE    0x00152118 /* [RW][32] SW may set this to a lower value to prevent the DAC from driving too high of a voltage */
#define BCHP_AVS_PVT_MNTR_CONFIG_MAX_DAC_CODE    0x0015211c /* [RW][32] SW may set this to a higher value to prevent the DAC from driving too low of a voltage */
#define BCHP_AVS_PVT_MNTR_CONFIG_PVT_MNTR_SW_RESETB 0x00152120 /* [RW][32] SW controlled PVTMON_resetb */
#define BCHP_AVS_PVT_MNTR_CONFIG_AVS_TOP_ANALOG_SRAM_INDICATOR 0x00152124 /* [RW][32] Control register to drive control bits for analog SRAM indicator */
