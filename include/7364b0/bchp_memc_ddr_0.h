...
#define BCHP_MEMC_DDR_0_CMD_LOOKAHEAD            0x00902088 /* Command Lookahead */
#define BCHP_MEMC_DDR_0_DFI_PHASE_ENABLE         0x0090208c /* Sequencer DFI Phase Enable */
#define BCHP_MEMC_DDR_0_STAT_CONTROL             0x00902300 /* Statistics Control register */
#define BCHP_MEMC_DDR_0_STAT_TIMER               0x00902304 /* Statistics Timer */
#define BCHP_MEMC_DDR_0_STAT_IDLE_NOP            0x00902308 /* DRAM Idle_NOP Cycle Count Register. */
#define BCHP_MEMC_DDR_0_STAT_MAX_IDLE_NOP        0x0090230c /* Maximum DRAM idle_NOP cycle count register. */
#define BCHP_MEMC_DDR_0_STAT_MIN_IDLE_NOP        0x00902310 /* Minimum DRAM idle_NOP cycle count register. */
#define BCHP_MEMC_DDR_0_STAT_CAS_ALL             0x00902314 /* CAS Count Register. */
#define BCHP_MEMC_DDR_0_STAT_MAX_CAS_ALL         0x00902318 /* Maximum DRAM CAS cycle count register. */
#define BCHP_MEMC_DDR_0_STAT_MIN_CAS_ALL         0x0090231c /* Minimum DRAM CAS cycle count register. */
#define BCHP_MEMC_DDR_0_STAT_PENALTY_ALL         0x00902320 /* DRAM Penalty Cycle Count register. */
#define BCHP_MEMC_DDR_0_STAT_PENALTY_GDDRWM      0x00902324 /* GDDR Write Mask Penalty Cycle Count register. */
#define BCHP_MEMC_DDR_0_STAT_PAGE_MERGE_ALL      0x00902328 /* Page Merge Event Count register. */
#define BCHP_MEMC_DDR_0_STAT_MAX_TRANS_CYCLES_ALL 0x0090232c /* Maximum number of transactions cycles (CAS+Penalty_ALL). */
#define BCHP_MEMC_DDR_0_STAT_MIN_TRANS_CYCLES_ALL 0x00902330 /* Minimum number of transactions cycles (CAS+Penalty_ALL). */
#define BCHP_MEMC_DDR_0_STAT_TRANS_READ_ALL      0x00902334 /* Number of overall system memory read transactions. */
#define BCHP_MEMC_DDR_0_STAT_TRANS_WRITE_ALL     0x00902338 /* Number of overall system memory write transactions. */
#define BCHP_MEMC_DDR_0_STAT_MAX_TRANS_ALL       0x0090233c /* Maximum Number of Overall System memory transactions. */
#define BCHP_MEMC_DDR_0_STAT_MIN_TRANS_ALL       0x00902340 /* Minimum Number of Overall System memory transactions. */
#define BCHP_MEMC_DDR_0_STAT_CLIENT_SERVICE_CAS  0x00902344 /* Service CAS Cycle Count register. */
#define BCHP_MEMC_DDR_0_STAT_MAX_CLIENT_SERVICE_CAS 0x00902348 /* Maximum service CAS cycle count register. */
#define BCHP_MEMC_DDR_0_STAT_MIN_CLIENT_SERVICE_CAS 0x0090234c /* Minimum service CAS cycle count register. */
#define BCHP_MEMC_DDR_0_STAT_CLIENT_SERVICE_INTR_PENALTY 0x00902350 /* Service Intra DRAM Penalty Cycle Count register. */
#define BCHP_MEMC_DDR_0_STAT_CLIENT_SERVICE_POST_PENALTY 0x00902354 /* Service Post DRAM Penalty Cycle Count register. */
#define BCHP_MEMC_DDR_0_STAT_CLIENT_SERVICE_GDDRWM_PENALTY 0x00902358 /* Service GDDR Write Mask Penalty Cycle Count register. */
#define BCHP_MEMC_DDR_0_STAT_CLIENT_SERVICE_PAGE_MERGES 0x0090235c /* Service Page Merge Event Count register. */
#define BCHP_MEMC_DDR_0_STAT_MAX_CLIENT_SERVICE_CYCLES 0x00902360 /* Maximum service cycle count register. */
#define BCHP_MEMC_DDR_0_STAT_MIN_CLIENT_SERVICE_CYCLES 0x00902364 /* Minimum service cycle count register. */
#define BCHP_MEMC_DDR_0_STAT_CLIENT_SERVICE_TRANS_READ 0x00902368 /* Service Read Transaction Count register. */
#define BCHP_MEMC_DDR_0_STAT_CLIENT_SERVICE_TRANS_WRITE 0x0090236c /* Service Write Transaction Count register. */
#define BCHP_MEMC_DDR_0_STAT_MAX_CLIENT_SERVICE_TRANS 0x00902370 /* Maximum service Transaction count register. */
#define BCHP_MEMC_DDR_0_STAT_MIN_CLIENT_SERVICE_TRANS 0x00902374 /* Minimum service cycle Transaction register. */
#define BCHP_MEMC_DDR_0_STAT_CLIENT_SERVICE_LATENCY 0x00902378 /* Service Latency Count register. */
#define BCHP_MEMC_DDR_0_STAT_MAX_CLIENT_SERVICE_LATENCY 0x0090237c /* Maximum Service Latency count register. */
#define BCHP_MEMC_DDR_0_STAT_MIN_CLIENT_SERVICE_LATENCY 0x00902380 /* Minimum Service Latency count register. */
#define BCHP_MEMC_DDR_0_STAT_CLIENT_ABS_MAX_SERVICE_LATENCY 0x00902384 /* Absolute Minimum Service Latency count register. */
#define BCHP_MEMC_DDR_0_STAT_CLIENT_ABS_MIN_SERVICE_LATENCY 0x00902388 /* Absolute Maximum Service Latency count register. */
#define BCHP_MEMC_DDR_0_STAT_REFRESH             0x0090238c /* Total number of refreshes issued. */
#define BCHP_MEMC_DDR_0_STAT_MIN_DQ_IDLE_WRITE   0x00902390 /* Min DQ Idle Write event counter */
#define BCHP_MEMC_DDR_0_STAT_MIN_DQ_IDLE_READ    0x00902394 /* Min DQ Idle Read event counter */
