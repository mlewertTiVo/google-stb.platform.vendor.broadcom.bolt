...
#define BCHP_AVS_HW_MNTR_INTERRUPT_POW_WDOG_EN_1 0x004d2080 /* Software to program a mask(1 bit per PWD) to indicate which PWD signals may trigger an interrupt */
