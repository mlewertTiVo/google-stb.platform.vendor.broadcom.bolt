 ...
 *
 *
 * Date:           Generated on              Thu Oct  9 03:13:43 2014
...
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRIVE_PAD_CTL 0x00906038 /* Drive strength control for all pads except CK_P, CK_N, CS, ODT and PAR */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRIVE_PAD_CTL_2T 0x0090603c /* Drive strength control for signals that are 1T when in 2T mode -- CS, ODT and PAR */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_STATIC_PAD_CTL 0x00906040 /* pad rx and tx characteristics control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_STATIC_PAD_CTL_2T 0x00906044 /* pad rx and tx characteristics control register for signals that are 1T when in 2T mode -- CS, ODT and PAR */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_RX_TRIM    0x00906048 /* Receiver trim */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_CONFIG 0x0090604c /* DRAM configuration register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_TIMING1 0x00906050 /* DRAM timing register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_TIMING2 0x00906054 /* DRAM timing register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_TIMING3 0x00906058 /* DRAM timing register #3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_TIMING4 0x0090605c /* DRAM timing register #4 */
...
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD00 0x00906088 /* DDR interface signal AD[00] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD01 0x0090608c /* DDR interface signal AD[01] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD02 0x00906090 /* DDR interface signal AD[02] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD03 0x00906094 /* DDR interface signal AD[03] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD04 0x00906098 /* DDR interface signal AD[04] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD05 0x0090609c /* DDR interface signal AD[05] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD06 0x009060a0 /* DDR interface signal AD[06] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD07 0x009060a4 /* DDR interface signal AD[07] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD08 0x009060a8 /* DDR interface signal AD[08] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD09 0x009060ac /* DDR interface signal AD[09] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD10 0x009060b0 /* DDR interface signal AD[10] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD11 0x009060b4 /* DDR interface signal AD[11] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD12 0x009060b8 /* DDR interface signal AD[12] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD13 0x009060bc /* DDR interface signal AD[13] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD14 0x009060c0 /* DDR interface signal AD[14] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD15 0x009060c4 /* DDR interface signal AD[15] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_BA0 0x009060c8 /* DDR interface signal BA[0] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_BA1 0x009060cc /* DDR interface signal BA[1] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_BA2 0x009060d0 /* DDR interface signal BA[2] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AUX0 0x009060d4 /* DDR interface signal AUX[0] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AUX1 0x009060d8 /* DDR interface signal AUX[1] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AUX2 0x009060dc /* DDR interface signal AUX[2] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_CS0 0x009060e0 /* DDR interface signal CS0 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_CS1 0x009060e4 /* DDR interface signal CS1 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_PAR 0x009060e8 /* DDR interface signal PAR VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_RAS_N 0x009060ec /* DDR interface signal RAS_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_CAS_N 0x009060f0 /* DDR interface signal CAS_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_CKE 0x009060f4 /* DDR interface signal CKE0 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_RST_N 0x009060f8 /* DDR interface signal RST_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_ODT 0x009060fc /* DDR interface signal ODT0 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_WE_N 0x00906100 /* DDR interface signal WE_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_DDR_CK 0x00906104 /* DDR interface signal DDR_CK VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CLK_CONTROL 0x00906108 /* DDR interface signal Write Leveling CLK VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_LDE_CONTROL 0x0090610c /* DDR interface signal Write Leveling Capture Enable VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CMD_CYC_DLY 0x00906110 /* GDDR5 command interface delay stage control */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_UPDATE_VDL 0x00906114 /* Update VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_UPDATE_VDL_SNOOP1 0x00906118 /* Update VDL snoop control register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_UPDATE_VDL_SNOOP2 0x0090611c /* Update VDL snoop control register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG1 0x00906120 /* DRAM Command Register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_AUX_REG1 0x00906124 /* DRAM AUX_N Command Register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG2 0x00906128 /* DRAM Command Register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_AUX_REG2 0x0090612c /* DRAM AUX_N Command Register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG3 0x00906130 /* DRAM Command Register #3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_AUX_REG3 0x00906134 /* DRAM AUX_N Command Register #3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG4 0x00906138 /* DRAM Command Register #4 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_AUX_REG4 0x0090613c /* DRAM AUX_N Command Register #4 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG_TIMER 0x00906140 /* DRAM Command Timer Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG0  0x00906144 /* DDR3/DDR4/GDDR5 Mode Register 0 and LPDDR Mode Register 1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG1  0x00906148 /* DDR3/DDR4/GDDR5 Mode Register 1 and LPDDR Mode Register 2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG2  0x0090614c /* DDR3/DDR4/GDDR5 Mode Register 2 and LPDDR Mode Register 3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG3  0x00906150 /* DDR3/DDR4/GDDR5 Mode Register 3 and LPDDR Mode Register 9 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG4  0x00906154 /* DDR4/GDDR5 Mode Register 4 and LPDDR Mode Register 10 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG5  0x00906158 /* DDR4/GDDR5 Mode Register 5 and LPDDR Mode Register 16 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG6  0x0090615c /* DDR4/GDDR5 Mode Register 6 and LPDDR Mode Register 17 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG7  0x00906160 /* DDR4/GDDR5 Mode Register 7 and LPDDR Mode Register 41 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG8  0x00906164 /* GDDR5 Mode Register 8 and LPDDR Mode Register 42 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG15 0x00906168 /* GDDR5 Mode Register 15 and LPDDR Mode Register 48 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG63 0x0090616c /* LPDDR Mode Register 63 */
...
#define BCHP_DDR34_PHY_CONTROL_REGS_0_WRITE_LEVELING_STATUS 0x0090618c /* Write leveling status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_READ_ENABLE_CONTROL 0x00906190 /* Read enable test cycle control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_READ_ENABLE_STATUS 0x00906194 /* Read enable test cycle status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_CONTROL 0x00906198 /* Virtual VTT Control and Status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_STATUS 0x0090619c /* Virtual VTT Control and Status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_CONNECTIONS 0x009061a0 /* Virtual VTT Connections register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_OVERRIDE 0x009061a4 /* Virtual VTT Override register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VREF_DAC_CONTROL 0x009061a8 /* VREF DAC Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_CNTRL 0x009061ac /* PhyBist Control Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_SEED 0x009061b0 /* PhyBist Seed Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_CA_MASK 0x009061b4 /* PhyBist Command/Address Bus Mask */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_DQ_MASK1 0x009061b8 /* PhyBist Data Bus Mask #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_DQ_MASK2 0x009061bc /* PhyBist Data Bus Mask #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_STATUS 0x009061c0 /* PhyBist General Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_CTL_STATUS 0x009061c4 /* PhyBist Per-Bit Control Pad Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL0_STATUS 0x009061c8 /* PhyBist Byte Lane #0 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL1_STATUS 0x009061cc /* PhyBist Byte Lane #1 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL2_STATUS 0x009061d0 /* PhyBist Byte Lane #2 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL3_STATUS 0x009061d4 /* PhyBist Byte Lane #3 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL4_STATUS 0x009061d8 /* PhyBist Byte Lane #4 (ECC) Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_STANDBY_CONTROL 0x009061dc /* Standby Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DEBUG_FREEZE_ENABLE 0x009061e0 /* Freeze-on-error enable register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DEBUG_MUX_CONTROL 0x009061e4 /* Debug Mux Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DFI_CNTRL  0x009061e8 /* DFI Interface Ownership Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_WRITE_ODT_CNTRL 0x009061ec /* Write ODT Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ABI_PAR_CNTRL 0x009061f0 /* ABI and PAR Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ZQ_CAL     0x009061f4 /* ZQ Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ZQ_CAL2    0x009061f8 /* ZQ Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMR_CAL   0x009061fc /* COMR Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_RO_PROC_MON_CTL 0x00906200 /* Ring-Osc control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_RO_PROC_MON_STATUS 0x00906204 /* Ring-Osc count register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CK_DRIVE_PAD_CTL 0x00906208 /* Drive strength control register for CK_P and CK_N */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_LDO_COMP_CONTROL 0x0090620c /* LDO Comparator Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_BYTE_LANE_ALIGN_MASKS 0x00906210 /* Byte-lane alignment mask register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CLOCK_IDLE 0x00906214 /* Clock Idle Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_AC_SPARE_REG 0x00906218 /* Address and Control Spare register */
