 ...
 ***************************************************************************/
#define BCHP_SDIO_0_HOST_SDMA                    0x20200000 /* [RW] System DMA Address Register */
#define BCHP_SDIO_0_HOST_BLOCK                   0x20200004 /* [RW] Block Reset and Count Register */
#define BCHP_SDIO_0_HOST_ARGUMENT                0x20200008 /* [RW] Argument Register */
#define BCHP_SDIO_0_HOST_CMD_MODE                0x2020000c /* [RW] Command and Mode Register */
#define BCHP_SDIO_0_HOST_RESP_01                 0x20200010 /* [RO] Response Word 0 and 1 */
#define BCHP_SDIO_0_HOST_RESP_23                 0x20200014 /* [RO] Response Word 2 and 3 */
#define BCHP_SDIO_0_HOST_RESP_45                 0x20200018 /* [RO] Response Word 4 and 5 */
#define BCHP_SDIO_0_HOST_RESP_67                 0x2020001c /* [RO] Response Word 6 and 7 */
#define BCHP_SDIO_0_HOST_BUFFDATA                0x20200020 /* [RW] Buffer Data Port for PIO Tranfers */
#define BCHP_SDIO_0_HOST_STATE                   0x20200024 /* [RO] Present State of Controller */
#define BCHP_SDIO_0_HOST_CTRL_SET0               0x20200028 /* [RW] SD Standard Control Registers for Host, Power, BlockGap, WakeUp */
#define BCHP_SDIO_0_HOST_CTRL_SET1               0x2020002c /* [RW] SD Standard Control Registers for Clock, Timeout, Resets */
#define BCHP_SDIO_0_HOST_INT_STATUS              0x20200030 /* [RW] Interrupt Status for Normal and Error conditions */
#define BCHP_SDIO_0_HOST_INT_STATUS_ENA          0x20200034 /* [RW] Interrupt Enables for Normal and Error conditions */
#define BCHP_SDIO_0_HOST_INT_SIGNAL_ENA          0x20200038 /* [RW] Interrupt Signal Enables for Normal and Error conditions */
#define BCHP_SDIO_0_HOST_AUTOCMD12_STAT          0x2020003c /* [RW] Auto Cmd12 Error Status */
#define BCHP_SDIO_0_HOST_CAPABLE                 0x20200040 /* [RO] Host Controller Capabilities to Software */
#define BCHP_SDIO_0_HOST_CAPABLE_1               0x20200044 /* [RO] Future Host Controller Capabilities to Software */
#define BCHP_SDIO_0_HOST_POWER_CAPABLE           0x20200048 /* [RO] Host Controller Power Capabilities to Software */
#define BCHP_SDIO_0_HOST_POWER_CAPABLE_RSVD      0x2020004c /* [RO] Future Host Controller Power Capabilities to Software */
#define BCHP_SDIO_0_HOST_FORCE_EVENTS            0x20200050 /* [RW] Force Events on Error Status Bits */
#define BCHP_SDIO_0_HOST_ADMA_ERR_STAT           0x20200054 /* [RO] ADMA Error Status Bits */
#define BCHP_SDIO_0_HOST_ADMA_SYSADDR_LO         0x20200058 /* [RW] ADMA System Address Low Bits */
#define BCHP_SDIO_0_HOST_ADMA_SYSADDR_HI         0x2020005c /* [RO] ADMA System Address High Bits */
#define BCHP_SDIO_0_HOST_PRESET_INIT_DEFAULT     0x20200060 /* [RO] Preset Values for init and default speed */
#define BCHP_SDIO_0_HOST_PRESET_HIGH_SPEED       0x20200064 /* [RO] Preset Values for high speed and SDR12 */
#define BCHP_SDIO_0_HOST_PRESET_SDR25_50         0x20200068 /* [RO] Preset Values for SDR25 and SDR50 */
#define BCHP_SDIO_0_HOST_PRESET_SDR104_DDR50     0x2020006c /* [RO] Preset Values for SDR104 and DDR50 */
#define BCHP_SDIO_0_HOST_BOOT_TIMEOUT            0x20200070 /* [RW] DAT line inactivity timeout on boot */
#define BCHP_SDIO_0_HOST_DEBUG_SELECT            0x20200074 /* [WO] Debug probe output selection */
#define BCHP_SDIO_0_HOST_SHARED_BUS_CTRL         0x202000e0 /* [RW] shared bus control */
#define BCHP_SDIO_0_HOST_SPI_INTERRUPT           0x202000f0 /* [RW] SPI Interrupt support */
#define BCHP_SDIO_0_HOST_VERSION_STATUS          0x202000fc /* [RO] Controller Version and Slot Status */
