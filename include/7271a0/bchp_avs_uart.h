 ...
 ***************************************************************************/
#define BCHP_AVS_UART_UARTDR                     0x204d0000 /* [RW] Data register (12 or 8 bits) */
#define BCHP_AVS_UART_UARTRSR                    0x204d0004 /* [RW] Receive status register/error clear register */
#define BCHP_AVS_UART_UARTFR                     0x204d0018 /* [RO] Flag register */
#define BCHP_AVS_UART_UARTILPR                   0x204d0020 /* [RW] IrDA low-power counter register */
#define BCHP_AVS_UART_UARTIBRD                   0x204d0024 /* [RW] Integer baud rate register */
#define BCHP_AVS_UART_UARTFBRD                   0x204d0028 /* [RW] Fractional baud rate register */
#define BCHP_AVS_UART_UARTLCR_H                  0x204d002c /* [RW] Line control register */
#define BCHP_AVS_UART_UARTCR                     0x204d0030 /* [RW] Control register */
#define BCHP_AVS_UART_UARTIFLS                   0x204d0034 /* [RW] Interrupt FIFO level select register */
#define BCHP_AVS_UART_UARTIMSC                   0x204d0038 /* [RW] Interrupt mask set/clear register */
#define BCHP_AVS_UART_UARTRIS                    0x204d003c /* [RO] Raw interrupt status register */
#define BCHP_AVS_UART_UARTMIS                    0x204d0040 /* [RO] Masked interrupt status register */
#define BCHP_AVS_UART_UARTICR                    0x204d0044 /* [WO] Interrupt clear register */
#define BCHP_AVS_UART_UARTDMACR                  0x204d0048 /* [RW] DMA control register */
#define BCHP_AVS_UART_UARTPERIPHID0              0x204d0fe0 /* [RO] UARTPeriphID0 */
#define BCHP_AVS_UART_UARTPERIPHID1              0x204d0fe4 /* [RO] UARTPeriphID1 */
#define BCHP_AVS_UART_UARTPERIPHID2              0x204d0fe8 /* [RO] UARTPeriphID2 */
#define BCHP_AVS_UART_UARTPERIPHID3              0x204d0fec /* [RO] UARTPeriphID3 */
#define BCHP_AVS_UART_UARTPCELLID0               0x204d0ff0 /* [RO] UARTPCellID0 */
#define BCHP_AVS_UART_UARTPCELLID1               0x204d0ff4 /* [RO] UARTPCellID1 */
#define BCHP_AVS_UART_UARTPCELLID2               0x204d0ff8 /* [RO] UARTPCellID2 */
#define BCHP_AVS_UART_UARTPCELLID3               0x204d0ffc /* [RO] UARTPCellID3 */
