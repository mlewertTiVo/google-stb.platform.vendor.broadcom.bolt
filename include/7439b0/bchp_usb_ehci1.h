 ...
 ***************************************************************************/
#define BCHP_USB_EHCI1_HCCAPBASE                 0x00470500 /* EHCI Capability Register */
#define BCHP_USB_EHCI1_HCSPARAMS                 0x00470504 /* EHCI Structural Parameter */
#define BCHP_USB_EHCI1_HCCPARAMS                 0x00470508 /* EHCI Capability Parameter */
#define BCHP_USB_EHCI1_USBCMD                    0x00470510 /* USB Command Register */
#define BCHP_USB_EHCI1_USBSTS                    0x00470514 /* USB Status  Register */
#define BCHP_USB_EHCI1_USBINTR                   0x00470518 /* USB Interrupt Enable Register */
#define BCHP_USB_EHCI1_FRINDEX                   0x0047051c /* USB Frame Index Register */
#define BCHP_USB_EHCI1_PERIODICLISTBASE          0x00470524 /* Periodic Frame List Base Address Register */
#define BCHP_USB_EHCI1_ASYNCLISTADDR             0x00470528 /* Asynchronous List Address */
#define BCHP_USB_EHCI1_CONFIGFLAG                0x00470550 /* Configured Flag Register */
#define BCHP_USB_EHCI1_PORTSC_0                  0x00470554 /* Port Status/Control Register for Port 0 */
#define BCHP_USB_EHCI1_INSNREG00                 0x00470590 /* Microframe Base Value Register */
#define BCHP_USB_EHCI1_INSNREG01                 0x00470594 /* Packet Buffer OUT/IN Threshold Register */
#define BCHP_USB_EHCI1_INSNREG02                 0x00470598 /* Packet Buffer Depth Register */
#define BCHP_USB_EHCI1_INSNREG03                 0x0047059c /* Break Memory Transfer Register */
#define BCHP_USB_EHCI1_INSNREG04                 0x004705a0 /* Debug Register */
#define BCHP_USB_EHCI1_INSNREG05                 0x004705a4 /* UTMI Control and Status Register */
