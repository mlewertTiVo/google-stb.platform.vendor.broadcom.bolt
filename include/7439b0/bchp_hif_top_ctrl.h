 ...
 ***************************************************************************/
#define BCHP_HIF_TOP_CTRL_EXT_IRQ_LEVEL          0x003e2000 /* External IRQ Active Level Control Register */
#define BCHP_HIF_TOP_CTRL_SPI_DBG_SEL            0x003e2004 /* SPI test port select register */
#define BCHP_HIF_TOP_CTRL_PM_CTRL0               0x003e200c /* HIF Power Management Control0 Register */
#define BCHP_HIF_TOP_CTRL_PM_CTRL1               0x003e2010 /* HIF Power Management Control1 Register */
#define BCHP_HIF_TOP_CTRL_PM_CTRL2               0x003e2014 /* HIF Power Management Control Register:used to control SDIO_0 (CARD) */
#define BCHP_HIF_TOP_CTRL_PM_CTRL3               0x003e2018 /* HIF Power Management Control Register:used to control SDIO_1 (EMMC) */
#define BCHP_HIF_TOP_CTRL_FLASH_TYPE             0x003e201c /* HIF Decoded Flash Type */
#define BCHP_HIF_TOP_CTRL_PDA_CTRL               0x003e2020 /* HIF PDA Control Register */
#define BCHP_HIF_TOP_CTRL_PDA_OUT_STATUS         0x003e2024 /* HIF PDA Out Status */
#define BCHP_HIF_TOP_CTRL_CPU_MODE_CTRL          0x003e2030 /* CPU MODE Control register (PUBLIC) */
#define BCHP_HIF_TOP_CTRL_CPU_MODE_STATUS        0x003e2034 /* CPU MODE Control status register (PUBLIC) */
#define BCHP_HIF_TOP_CTRL_SCRATCH                0x003e203c /* HIF Scratch Register */
