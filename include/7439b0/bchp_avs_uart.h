 ...
 ***************************************************************************/
#define BCHP_AVS_UART_UARTDR                     0x004d0000 /* Data register (12 or 8 bits) */
#define BCHP_AVS_UART_UARTRSR                    0x004d0004 /* Receive status register/error clear register */
#define BCHP_AVS_UART_UARTFR                     0x004d0018 /* Flag register */
#define BCHP_AVS_UART_UARTILPR                   0x004d0020 /* IrDA low-power counter register */
#define BCHP_AVS_UART_UARTIBRD                   0x004d0024 /* Integer baud rate register */
#define BCHP_AVS_UART_UARTFBRD                   0x004d0028 /* Fractional baud rate register */
#define BCHP_AVS_UART_UARTLCR_H                  0x004d002c /* Line control register */
#define BCHP_AVS_UART_UARTCR                     0x004d0030 /* Control register */
#define BCHP_AVS_UART_UARTIFLS                   0x004d0034 /* Interrupt FIFO level select register */
#define BCHP_AVS_UART_UARTIMSC                   0x004d0038 /* Interrupt mask set/clear register */
#define BCHP_AVS_UART_UARTRIS                    0x004d003c /* Raw interrupt status register */
#define BCHP_AVS_UART_UARTMIS                    0x004d0040 /* Masked interrupt status register */
#define BCHP_AVS_UART_UARTICR                    0x004d0044 /* Interrupt clear register */
#define BCHP_AVS_UART_UARTDMACR                  0x004d0048 /* DMA control register */
#define BCHP_AVS_UART_UARTPERIPHID0              0x004d0fe0 /* UARTPeriphID0 */
#define BCHP_AVS_UART_UARTPERIPHID1              0x004d0fe4 /* UARTPeriphID1 */
#define BCHP_AVS_UART_UARTPERIPHID2              0x004d0fe8 /* UARTPeriphID2 */
#define BCHP_AVS_UART_UARTPERIPHID3              0x004d0fec /* UARTPeriphID3 */
#define BCHP_AVS_UART_UARTPCELLID0               0x004d0ff0 /* UARTPCellID0 */
#define BCHP_AVS_UART_UARTPCELLID1               0x004d0ff4 /* UARTPCellID1 */
#define BCHP_AVS_UART_UARTPCELLID2               0x004d0ff8 /* UARTPCellID2 */
#define BCHP_AVS_UART_UARTPCELLID3               0x004d0ffc /* UARTPCellID3 */
