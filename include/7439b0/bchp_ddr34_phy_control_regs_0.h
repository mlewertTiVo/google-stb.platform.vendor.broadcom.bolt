 ...
 ***************************************************************************/
#define BCHP_DDR34_PHY_CONTROL_REGS_0_REVISION   0x01120000 /* Address & Control revision register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_STATUS 0x01120004 /* PHY PLL status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG 0x01120008 /* PHY PLL configuration register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONTROL1 0x0112000c /* PHY PLL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONTROL2 0x01120010 /* PHY PLL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONTROL3 0x01120014 /* PHY PLL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_DIVIDERS 0x01120018 /* PHY PLL integer divider register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_FRAC_DIVIDER 0x0112001c /* PHY PLL fractional divider register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_SS_CONTROL 0x01120020 /* PHY PLL spread spectrum control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_SS_LIMIT 0x01120024 /* PHY PLL spread spectrum limit register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_AUX_CONTROL 0x01120028 /* Aux Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_IDLE_PAD_CONTROL 0x0112002c /* Idle mode pad control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_IDLE_PAD_ENABLE0 0x01120030 /* Idle mode pad enable register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_IDLE_PAD_ENABLE1 0x01120034 /* Idle mode pad enable register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRIVE_PAD_CTL 0x01120038 /* Drive strength control for all pads except CK_P, CK_N, CS, ODT and PAR */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRIVE_PAD_CTL_2T 0x0112003c /* Drive strength control for signals that are 1T when in 2T mode -- CS, ODT and PAR */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_STATIC_PAD_CTL 0x01120040 /* pad rx and tx characteristics control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_STATIC_PAD_CTL_2T 0x01120044 /* pad rx and tx characteristics control register for signals that are 1T when in 2T mode -- CS, ODT and PAR */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_RX_TRIM    0x01120048 /* Receiver trim */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_CONFIG 0x0112004c /* DRAM configuration register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_TIMING1 0x01120050 /* DRAM timing register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_TIMING2 0x01120054 /* DRAM timing register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_TIMING3 0x01120058 /* DRAM timing register #3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_TIMING4 0x0112005c /* DRAM timing register #4 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CALIBRATE 0x01120060 /* PHY VDL calibration control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CALIB_STATUS1 0x01120064 /* PHY VDL calibration status register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CALIB_STATUS2 0x01120068 /* PHY VDL calibration status register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_CONTROL 0x0112006c /* PHY VDL delay monitoring control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_REF 0x01120070 /* PHY VDL delay monitoring reference register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_STATUS 0x01120074 /* PHY VDL delay monitoring status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_OVERRIDE 0x01120078 /* PHY VDL delay monitoring override register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_OUT_CONTROL 0x0112007c /* PHY VDL delay monitoring output control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_OUT_STATUS 0x01120080 /* PHY VDL delay monitoring output status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_OUT_STATUS_CLEAR 0x01120084 /* PHY VDL delay monitoring output status clear register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD00 0x01120088 /* DDR interface signal AD[00] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD01 0x0112008c /* DDR interface signal AD[01] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD02 0x01120090 /* DDR interface signal AD[02] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD03 0x01120094 /* DDR interface signal AD[03] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD04 0x01120098 /* DDR interface signal AD[04] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD05 0x0112009c /* DDR interface signal AD[05] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD06 0x011200a0 /* DDR interface signal AD[06] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD07 0x011200a4 /* DDR interface signal AD[07] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD08 0x011200a8 /* DDR interface signal AD[08] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD09 0x011200ac /* DDR interface signal AD[09] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD10 0x011200b0 /* DDR interface signal AD[10] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD11 0x011200b4 /* DDR interface signal AD[11] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD12 0x011200b8 /* DDR interface signal AD[12] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD13 0x011200bc /* DDR interface signal AD[13] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD14 0x011200c0 /* DDR interface signal AD[14] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD15 0x011200c4 /* DDR interface signal AD[15] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_BA0 0x011200c8 /* DDR interface signal BA[0] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_BA1 0x011200cc /* DDR interface signal BA[1] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_BA2 0x011200d0 /* DDR interface signal BA[2] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AUX0 0x011200d4 /* DDR interface signal AUX[0] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AUX1 0x011200d8 /* DDR interface signal AUX[1] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AUX2 0x011200dc /* DDR interface signal AUX[2] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_CS0 0x011200e0 /* DDR interface signal CS0 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_CS1 0x011200e4 /* DDR interface signal CS1 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_PAR 0x011200e8 /* DDR interface signal PAR VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_RAS_N 0x011200ec /* DDR interface signal RAS_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_CAS_N 0x011200f0 /* DDR interface signal CAS_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_CKE 0x011200f4 /* DDR interface signal CKE0 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_RST_N 0x011200f8 /* DDR interface signal RST_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_ODT 0x011200fc /* DDR interface signal ODT0 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_WE_N 0x01120100 /* DDR interface signal WE_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_DDR_CK 0x01120104 /* DDR interface signal DDR_CK VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CLK_CONTROL 0x01120108 /* DDR interface signal Write Leveling CLK VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_LDE_CONTROL 0x0112010c /* DDR interface signal Write Leveling Capture Enable VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CMD_CYC_DLY 0x01120110 /* GDDR5 command interface delay stage control */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_UPDATE_VDL 0x01120114 /* Update VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_UPDATE_VDL_SNOOP1 0x01120118 /* Update VDL snoop control register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_UPDATE_VDL_SNOOP2 0x0112011c /* Update VDL snoop control register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG1 0x01120120 /* DRAM Command Register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_AUX_REG1 0x01120124 /* DRAM AUX_N Command Register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG2 0x01120128 /* DRAM Command Register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_AUX_REG2 0x0112012c /* DRAM AUX_N Command Register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG3 0x01120130 /* DRAM Command Register #3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_AUX_REG3 0x01120134 /* DRAM AUX_N Command Register #3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG4 0x01120138 /* DRAM Command Register #4 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_AUX_REG4 0x0112013c /* DRAM AUX_N Command Register #4 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG_TIMER 0x01120140 /* DRAM Command Timer Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG0  0x01120144 /* DDR3/DDR4/GDDR5 Mode Register 0 and LPDDR Mode Register 1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG1  0x01120148 /* DDR3/DDR4/GDDR5 Mode Register 1 and LPDDR Mode Register 2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG2  0x0112014c /* DDR3/DDR4/GDDR5 Mode Register 2 and LPDDR Mode Register 3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG3  0x01120150 /* DDR3/DDR4/GDDR5 Mode Register 3 and LPDDR Mode Register 9 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG4  0x01120154 /* DDR4/GDDR5 Mode Register 4 and LPDDR Mode Register 10 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG5  0x01120158 /* DDR4/GDDR5 Mode Register 5 and LPDDR Mode Register 16 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG6  0x0112015c /* DDR4/GDDR5 Mode Register 6 and LPDDR Mode Register 17 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG7  0x01120160 /* DDR4/GDDR5 Mode Register 7 and LPDDR Mode Register 41 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG8  0x01120164 /* GDDR5 Mode Register 8 and LPDDR Mode Register 42 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG15 0x01120168 /* GDDR5 Mode Register 15 and LPDDR Mode Register 48 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG63 0x0112016c /* LPDDR Mode Register 63 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ALERT_CLEAR 0x01120170 /* DDR4 Alert status clear register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ALERT_STATUS 0x01120174 /* DDR4 Alert status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ALERT_DFI  0x01120178 /* DDR4 Alert DFI BL mask */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CA_PLAYBACK_CONTROL 0x0112017c /* GDDR5 CA playback control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CA_PLAYBACK_STATUS0 0x01120180 /* LPDDR3 and GDDR5 CA playback status register0 (for BL0 and BL1) */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CA_PLAYBACK_STATUS1 0x01120184 /* LPDDR3 and GDDR5 CA playback status register1 (for BL2 and BL3) */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_WRITE_LEVELING_CONTROL 0x01120188 /* Write leveling control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_WRITE_LEVELING_STATUS 0x0112018c /* Write leveling status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_READ_ENABLE_CONTROL 0x01120190 /* Read enable test cycle control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_READ_ENABLE_STATUS 0x01120194 /* Read enable test cycle status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_CONTROL 0x01120198 /* Virtual VTT Control and Status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_STATUS 0x0112019c /* Virtual VTT Control and Status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_CONNECTIONS 0x011201a0 /* Virtual VTT Connections register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_OVERRIDE 0x011201a4 /* Virtual VTT Override register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VREF_DAC_CONTROL 0x011201a8 /* VREF DAC Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_CNTRL 0x011201ac /* PhyBist Control Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_SEED 0x011201b0 /* PhyBist Seed Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_CA_MASK 0x011201b4 /* PhyBist Command/Address Bus Mask */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_DQ_MASK1 0x011201b8 /* PhyBist Data Bus Mask #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_DQ_MASK2 0x011201bc /* PhyBist Data Bus Mask #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_STATUS 0x011201c0 /* PhyBist General Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_CTL_STATUS 0x011201c4 /* PhyBist Per-Bit Control Pad Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL0_STATUS 0x011201c8 /* PhyBist Byte Lane #0 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL1_STATUS 0x011201cc /* PhyBist Byte Lane #1 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL2_STATUS 0x011201d0 /* PhyBist Byte Lane #2 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL3_STATUS 0x011201d4 /* PhyBist Byte Lane #3 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL4_STATUS 0x011201d8 /* PhyBist Byte Lane #4 (ECC) Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_STANDBY_CONTROL 0x011201dc /* Standby Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DEBUG_FREEZE_ENABLE 0x011201e0 /* Freeze-on-error enable register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DEBUG_MUX_CONTROL 0x011201e4 /* Debug Mux Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DFI_CNTRL  0x011201e8 /* DFI Interface Ownership Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_WRITE_ODT_CNTRL 0x011201ec /* Write ODT Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ABI_PAR_CNTRL 0x011201f0 /* ABI and PAR Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ZQ_CAL     0x011201f4 /* ZQ Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ZQ_CAL2    0x011201f8 /* ZQ Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMR_CAL   0x011201fc /* COMR Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_RO_PROC_MON_CTL 0x01120200 /* Ring-Osc control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_RO_PROC_MON_STATUS 0x01120204 /* Ring-Osc count register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CK_DRIVE_PAD_CTL 0x01120208 /* Drive strength control register for CK_P and CK_N */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_LDO_COMP_CONTROL 0x0112020c /* LDO Comparator Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_BYTE_LANE_ALIGN_MASKS 0x01120210 /* Byte-lane alignment mask register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CLOCK_IDLE 0x01120214 /* Clock Idle Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_AC_SPARE_REG 0x01120218 /* Address and Control Spare register */
