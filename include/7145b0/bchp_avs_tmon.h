 ...
 *
 *
 * Date:           Generated on              Thu May 22 03:10:30 2014
 *                 Full Compile MD5 Checksum 84495cfb521a3de151bd815142a15db9
 ...
 ***************************************************************************/
#define BCHP_AVS_TMON_TEMPERATURE_MEASUREMENT_STATUS 0x20431500 /* Indicate temperature measurement data and validity of data */
#define BCHP_AVS_TMON_ENABLE_OVER_TEMPERATURE_RESET 0x20431504 /* Enable over temperature reset */
#define BCHP_AVS_TMON_TEMPERATURE_RESET_THRESHOLD 0x20431508 /* Represent threshold for over temperature reset */
#define BCHP_AVS_TMON_TEMPERATURE_INTERRUPT_IDLE_TIME 0x20431510 /* No new temperature interrupt can be generated for interval defined by this idle time */
#define BCHP_AVS_TMON_ENABLE_TEMPERATURE_INTERRUPT_SOURCES 0x20431514 /* Enable high and low temperature interrupts */
#define BCHP_AVS_TMON_TEMPERATURE_INTERRUPT_THRESHOLDS 0x20431518 /* Represent thresholds for high and low temperature interrupts */
#define BCHP_AVS_TMON_TEMPERATURE_INTERRUPT_TEMPERATURE 0x2043151c /* Temperature code associated with temperature interrupt event */
#define BCHP_AVS_TMON_TP_TMON_TEST_ENABLE        0x20431520 /* Enabling TP mode to use data from tp_in for testing TMON */
#define BCHP_AVS_TMON_SPARE_0                    0x20431524 /* Spare register 0 for AVS TEMPERATURE MONITOR core */
