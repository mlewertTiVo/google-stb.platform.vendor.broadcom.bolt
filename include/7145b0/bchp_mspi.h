 ...
 *MSPI - Master SPI
 ***************************************************************************/
#define BCHP_MSPI_SPCR0_LSB                      0x20416000 /* SPCR0_LSB REGISTER */
#define BCHP_MSPI_SPCR0_MSB                      0x20416004 /* SPCR0_MSB Register */
#define BCHP_MSPI_SPCR1_LSB                      0x20416008 /* SPCR1_LSB REGISTER */
#define BCHP_MSPI_SPCR1_MSB                      0x2041600c /* SPCR1_MSB REGISTER */
#define BCHP_MSPI_NEWQP                          0x20416010 /* NEWQP REGISTER */
#define BCHP_MSPI_ENDQP                          0x20416014 /* ENDQP REGISTER */
#define BCHP_MSPI_SPCR2                          0x20416018 /* SPCR2 REGISTER */
#define BCHP_MSPI_MSPI_STATUS                    0x20416020 /* MSPI STATUS REGISTER */
#define BCHP_MSPI_CPTQP                          0x20416024 /* CPTQP REGISTER */
#define BCHP_MSPI_SPCR3                          0x20416028 /* SPCR3 REGISTER */
#define BCHP_MSPI_REVISION                       0x2041602c /* REVISION ID REGISTER */
#define BCHP_MSPI_TXRAM00                        0x20416040 /* Most significant byte of TXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_TXRAM01                        0x20416044 /* Least significant byte of TXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_TXRAM02                        0x20416048 /* Most significant byte of TXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_TXRAM03                        0x2041604c /* Least significant byte of TXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_TXRAM04                        0x20416050 /* Most significant byte of TXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_TXRAM05                        0x20416054 /* Least significant byte of TXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_TXRAM06                        0x20416058 /* Most significant byte of TXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_TXRAM07                        0x2041605c /* Least significant byte of TXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_TXRAM08                        0x20416060 /* Most significant byte of TXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_TXRAM09                        0x20416064 /* Least significant byte of TXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_TXRAM10                        0x20416068 /* Most significant byte of TXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_TXRAM11                        0x2041606c /* Least significant byte of TXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_TXRAM12                        0x20416070 /* Most significant byte of TXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_TXRAM13                        0x20416074 /* Least significant byte of TXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_TXRAM14                        0x20416078 /* Most significant byte of TXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_TXRAM15                        0x2041607c /* Least significant byte of TXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_TXRAM16                        0x20416080 /* Most significant byte of TXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_TXRAM17                        0x20416084 /* Least significant byte of TXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_TXRAM18                        0x20416088 /* Most significant byte of TXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_TXRAM19                        0x2041608c /* Least significant byte of TXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_TXRAM20                        0x20416090 /* Most significant byte of TXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_TXRAM21                        0x20416094 /* Least significant byte of TXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_TXRAM22                        0x20416098 /* Most significant byte of TXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_TXRAM23                        0x2041609c /* Least significant byte of TXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_TXRAM24                        0x204160a0 /* Most significant byte of TXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_TXRAM25                        0x204160a4 /* Least significant byte of TXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_TXRAM26                        0x204160a8 /* Most significant byte of TXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_TXRAM27                        0x204160ac /* Least significant byte of TXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_TXRAM28                        0x204160b0 /* Most significant byte of TXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_TXRAM29                        0x204160b4 /* Least significant byte of TXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_TXRAM30                        0x204160b8 /* Most significant byte of TXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_TXRAM31                        0x204160bc /* Least significant byte of TXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_RXRAM00                        0x204160c0 /* Most significant byte of RXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_RXRAM01                        0x204160c4 /* Least significant byte of RXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_RXRAM02                        0x204160c8 /* Most significant byte of RXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_RXRAM03                        0x204160cc /* Least significant byte of RXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_RXRAM04                        0x204160d0 /* Most significant byte of RXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_RXRAM05                        0x204160d4 /* Least significant byte of RXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_RXRAM06                        0x204160d8 /* Most significant byte of RXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_RXRAM07                        0x204160dc /* Least significant byte of RXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_RXRAM08                        0x204160e0 /* Most significant byte of RXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_RXRAM09                        0x204160e4 /* Least significant byte of RXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_RXRAM10                        0x204160e8 /* Most significant byte of RXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_RXRAM11                        0x204160ec /* Least significant byte of RXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_RXRAM12                        0x204160f0 /* Most significant byte of RXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_RXRAM13                        0x204160f4 /* Least significant byte of RXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_RXRAM14                        0x204160f8 /* Most significant byte of RXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_RXRAM15                        0x204160fc /* Least significant byte of RXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_RXRAM16                        0x20416100 /* Most significant byte of RXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_RXRAM17                        0x20416104 /* Least significant byte of RXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_RXRAM18                        0x20416108 /* Most significant byte of RXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_RXRAM19                        0x2041610c /* Least significant byte of RXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_RXRAM20                        0x20416110 /* Most significant byte of RXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_RXRAM21                        0x20416114 /* Least significant byte of RXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_RXRAM22                        0x20416118 /* Most significant byte of RXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_RXRAM23                        0x2041611c /* Least significant byte of RXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_RXRAM24                        0x20416120 /* Most significant byte of RXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_RXRAM25                        0x20416124 /* Least significant byte of RXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_RXRAM26                        0x20416128 /* Most significant byte of RXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_RXRAM27                        0x2041612c /* Least significant byte of RXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_RXRAM28                        0x20416130 /* Most significant byte of RXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_RXRAM29                        0x20416134 /* Least significant byte of RXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_RXRAM30                        0x20416138 /* Most significant byte of RXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_RXRAM31                        0x2041613c /* Least significant byte of RXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_CDRAM00                        0x20416140 /* 8-bit command (queue pointer = 0) */
#define BCHP_MSPI_CDRAM01                        0x20416144 /* 8-bit command (queue pointer = 1) */
#define BCHP_MSPI_CDRAM02                        0x20416148 /* 8-bit command (queue pointer = 2) */
#define BCHP_MSPI_CDRAM03                        0x2041614c /* 8-bit command (queue pointer = 3) */
#define BCHP_MSPI_CDRAM04                        0x20416150 /* 8-bit command (queue pointer = 4) */
#define BCHP_MSPI_CDRAM05                        0x20416154 /* 8-bit command (queue pointer = 5) */
#define BCHP_MSPI_CDRAM06                        0x20416158 /* 8-bit command (queue pointer = 6) */
#define BCHP_MSPI_CDRAM07                        0x2041615c /* 8-bit command (queue pointer = 7) */
#define BCHP_MSPI_CDRAM08                        0x20416160 /* 8-bit command (queue pointer = 8) */
#define BCHP_MSPI_CDRAM09                        0x20416164 /* 8-bit command (queue pointer = 9) */
#define BCHP_MSPI_CDRAM10                        0x20416168 /* 8-bit command (queue pointer = a) */
#define BCHP_MSPI_CDRAM11                        0x2041616c /* 8-bit command (queue pointer = b) */
#define BCHP_MSPI_CDRAM12                        0x20416170 /* 8-bit command (queue pointer = c) */
#define BCHP_MSPI_CDRAM13                        0x20416174 /* 8-bit command (queue pointer = d) */
#define BCHP_MSPI_CDRAM14                        0x20416178 /* 8-bit command (queue pointer = e) */
#define BCHP_MSPI_CDRAM15                        0x2041617c /* 8-bit command (queue pointer = f) */
