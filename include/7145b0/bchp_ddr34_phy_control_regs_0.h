 ...
 ***************************************************************************/
#define BCHP_DDR34_PHY_CONTROL_REGS_0_REVISION   0x21506000 /* Address & Control revision register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_STATUS 0x21506004 /* PHY PLL status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG 0x21506008 /* PHY PLL configuration register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONTROL1 0x2150600c /* PHY PLL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONTROL2 0x21506010 /* PHY PLL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONTROL3 0x21506014 /* PHY PLL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_DIVIDERS 0x21506018 /* PHY PLL integer divider register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_FRAC_DIVIDER 0x2150601c /* PHY PLL fractional divider register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_SS_CONTROL 0x21506020 /* PHY PLL spread spectrum control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_SS_LIMIT 0x21506024 /* PHY PLL spread spectrum limit register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_AUX_CONTROL 0x21506028 /* Aux Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_IDLE_PAD_CONTROL 0x2150602c /* Idle mode pad control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_IDLE_PAD_ENABLE0 0x21506030 /* Idle mode pad enable register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_IDLE_PAD_ENABLE1 0x21506034 /* Idle mode pad enable register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRIVE_PAD_CTL 0x21506038 /* Drive strength control for all pads except CK_P, CK_N, CS, ODT and PAR */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRIVE_PAD_CTL_2T 0x2150603c /* Drive strength control for signals that are 1T when in 2T mode -- CS, ODT and PAR */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_STATIC_PAD_CTL 0x21506040 /* pad rx and tx characteristics control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_STATIC_PAD_CTL_2T 0x21506044 /* pad rx and tx characteristics control register for signals that are 1T when in 2T mode -- CS, ODT and PAR */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_RX_TRIM    0x21506048 /* Receiver trim */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_CONFIG 0x2150604c /* DRAM configuration register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_TIMING1 0x21506050 /* DRAM timing register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_TIMING2 0x21506054 /* DRAM timing register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_TIMING3 0x21506058 /* DRAM timing register #3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRAM_TIMING4 0x2150605c /* DRAM timing register #4 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CALIBRATE 0x21506060 /* PHY VDL calibration control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CALIB_STATUS1 0x21506064 /* PHY VDL calibration status register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CALIB_STATUS2 0x21506068 /* PHY VDL calibration status register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_CONTROL 0x2150606c /* PHY VDL delay monitoring control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_REF 0x21506070 /* PHY VDL delay monitoring reference register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_STATUS 0x21506074 /* PHY VDL delay monitoring status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_OVERRIDE 0x21506078 /* PHY VDL delay monitoring override register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_OUT_CONTROL 0x2150607c /* PHY VDL delay monitoring output control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_OUT_STATUS 0x21506080 /* PHY VDL delay monitoring output status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_OUT_STATUS_CLEAR 0x21506084 /* PHY VDL delay monitoring output status clear register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD00 0x21506088 /* DDR interface signal AD[00] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD01 0x2150608c /* DDR interface signal AD[01] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD02 0x21506090 /* DDR interface signal AD[02] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD03 0x21506094 /* DDR interface signal AD[03] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD04 0x21506098 /* DDR interface signal AD[04] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD05 0x2150609c /* DDR interface signal AD[05] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD06 0x215060a0 /* DDR interface signal AD[06] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD07 0x215060a4 /* DDR interface signal AD[07] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD08 0x215060a8 /* DDR interface signal AD[08] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD09 0x215060ac /* DDR interface signal AD[09] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD10 0x215060b0 /* DDR interface signal AD[10] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD11 0x215060b4 /* DDR interface signal AD[11] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD12 0x215060b8 /* DDR interface signal AD[12] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD13 0x215060bc /* DDR interface signal AD[13] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD14 0x215060c0 /* DDR interface signal AD[14] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AD15 0x215060c4 /* DDR interface signal AD[15] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_BA0 0x215060c8 /* DDR interface signal BA[0] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_BA1 0x215060cc /* DDR interface signal BA[1] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_BA2 0x215060d0 /* DDR interface signal BA[2] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AUX0 0x215060d4 /* DDR interface signal AUX[0] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AUX1 0x215060d8 /* DDR interface signal AUX[1] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_AUX2 0x215060dc /* DDR interface signal AUX[2] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_CS0 0x215060e0 /* DDR interface signal CS0 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_CS1 0x215060e4 /* DDR interface signal CS1 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_PAR 0x215060e8 /* DDR interface signal PAR VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_RAS_N 0x215060ec /* DDR interface signal RAS_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_CAS_N 0x215060f0 /* DDR interface signal CAS_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_CKE 0x215060f4 /* DDR interface signal CKE0 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_RST_N 0x215060f8 /* DDR interface signal RST_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_ODT 0x215060fc /* DDR interface signal ODT0 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_WE_N 0x21506100 /* DDR interface signal WE_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CONTROL_DDR_CK 0x21506104 /* DDR interface signal DDR_CK VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_CLK_CONTROL 0x21506108 /* DDR interface signal Write Leveling CLK VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_LDE_CONTROL 0x2150610c /* DDR interface signal Write Leveling Capture Enable VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CMD_CYC_DLY 0x21506110 /* GDDR5 command interface delay stage control */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_UPDATE_VDL 0x21506114 /* Update VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_UPDATE_VDL_SNOOP1 0x21506118 /* Update VDL snoop control register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_UPDATE_VDL_SNOOP2 0x2150611c /* Update VDL snoop control register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG1 0x21506120 /* DRAM Command Register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_AUX_REG1 0x21506124 /* DRAM AUX_N Command Register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG2 0x21506128 /* DRAM Command Register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_AUX_REG2 0x2150612c /* DRAM AUX_N Command Register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG3 0x21506130 /* DRAM Command Register #3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_AUX_REG3 0x21506134 /* DRAM AUX_N Command Register #3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG4 0x21506138 /* DRAM Command Register #4 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_AUX_REG4 0x2150613c /* DRAM AUX_N Command Register #4 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMMAND_REG_TIMER 0x21506140 /* DRAM Command Timer Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG0  0x21506144 /* DDR3/DDR4/GDDR5 Mode Register 0 and LPDDR Mode Register 1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG1  0x21506148 /* DDR3/DDR4/GDDR5 Mode Register 1 and LPDDR Mode Register 2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG2  0x2150614c /* DDR3/DDR4/GDDR5 Mode Register 2 and LPDDR Mode Register 3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG3  0x21506150 /* DDR3/DDR4/GDDR5 Mode Register 3 and LPDDR Mode Register 9 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG4  0x21506154 /* DDR4/GDDR5 Mode Register 4 and LPDDR Mode Register 10 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG5  0x21506158 /* DDR4/GDDR5 Mode Register 5 and LPDDR Mode Register 16 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG6  0x2150615c /* DDR4/GDDR5 Mode Register 6 and LPDDR Mode Register 17 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG7  0x21506160 /* DDR4/GDDR5 Mode Register 7 and LPDDR Mode Register 41 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG8  0x21506164 /* GDDR5 Mode Register 8 and LPDDR Mode Register 42 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG15 0x21506168 /* GDDR5 Mode Register 15 and LPDDR Mode Register 48 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_MODE_REG63 0x2150616c /* LPDDR Mode Register 63 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ALERT_CLEAR 0x21506170 /* DDR4 Alert status clear register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ALERT_STATUS 0x21506174 /* DDR4 Alert status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ALERT_DFI  0x21506178 /* DDR4 Alert DFI BL mask */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CA_PLAYBACK_CONTROL 0x2150617c /* GDDR5 CA playback control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CA_PLAYBACK_STATUS0 0x21506180 /* LPDDR3 and GDDR5 CA playback status register0 (for BL0 and BL1) */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CA_PLAYBACK_STATUS1 0x21506184 /* LPDDR3 and GDDR5 CA playback status register1 (for BL2 and BL3) */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_WRITE_LEVELING_CONTROL 0x21506188 /* Write leveling control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_WRITE_LEVELING_STATUS 0x2150618c /* Write leveling status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_READ_ENABLE_CONTROL 0x21506190 /* Read enable test cycle control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_READ_ENABLE_STATUS 0x21506194 /* Read enable test cycle status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_CONTROL 0x21506198 /* Virtual VTT Control and Status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_STATUS 0x2150619c /* Virtual VTT Control and Status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_CONNECTIONS 0x215061a0 /* Virtual VTT Connections register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_OVERRIDE 0x215061a4 /* Virtual VTT Override register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VREF_DAC_CONTROL 0x215061a8 /* VREF DAC Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_CNTRL 0x215061ac /* PhyBist Control Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_SEED 0x215061b0 /* PhyBist Seed Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_CA_MASK 0x215061b4 /* PhyBist Command/Address Bus Mask */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_DQ_MASK1 0x215061b8 /* PhyBist Data Bus Mask #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_DQ_MASK2 0x215061bc /* PhyBist Data Bus Mask #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_STATUS 0x215061c0 /* PhyBist General Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_CTL_STATUS 0x215061c4 /* PhyBist Per-Bit Control Pad Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL0_STATUS 0x215061c8 /* PhyBist Byte Lane #0 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL1_STATUS 0x215061cc /* PhyBist Byte Lane #1 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL2_STATUS 0x215061d0 /* PhyBist Byte Lane #2 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL3_STATUS 0x215061d4 /* PhyBist Byte Lane #3 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL4_STATUS 0x215061d8 /* PhyBist Byte Lane #4 (ECC) Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_STANDBY_CONTROL 0x215061dc /* Standby Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DEBUG_FREEZE_ENABLE 0x215061e0 /* Freeze-on-error enable register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DEBUG_MUX_CONTROL 0x215061e4 /* Debug Mux Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DFI_CNTRL  0x215061e8 /* DFI Interface Ownership Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_WRITE_ODT_CNTRL 0x215061ec /* Write ODT Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ABI_PAR_CNTRL 0x215061f0 /* ABI and PAR Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ZQ_CAL     0x215061f4 /* ZQ Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ZQ_CAL2    0x215061f8 /* ZQ Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMR_CAL   0x215061fc /* COMR Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_RO_PROC_MON_CTL 0x21506200 /* Ring-Osc control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_RO_PROC_MON_STATUS 0x21506204 /* Ring-Osc count register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CK_DRIVE_PAD_CTL 0x21506208 /* Drive strength control register for CK_P and CK_N */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_LDO_COMP_CONTROL 0x2150620c /* LDO Comparator Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_BYTE_LANE_ALIGN_MASKS 0x21506210 /* Byte-lane alignment mask register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CLOCK_IDLE 0x21506214 /* Clock Idle Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_AC_SPARE_REG 0x21506218 /* Address and Control Spare register */
