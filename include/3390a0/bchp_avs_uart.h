 ...
 ***************************************************************************/
#define BCHP_AVS_UART_UARTDR                     0x20430000 /* Data register (12 or 8 bits) */
#define BCHP_AVS_UART_UARTRSR                    0x20430004 /* Receive status register/error clear register */
#define BCHP_AVS_UART_UARTFR                     0x20430018 /* Flag register */
#define BCHP_AVS_UART_UARTILPR                   0x20430020 /* IrDA low-power counter register */
#define BCHP_AVS_UART_UARTIBRD                   0x20430024 /* Integer baud rate register */
#define BCHP_AVS_UART_UARTFBRD                   0x20430028 /* Fractional baud rate register */
#define BCHP_AVS_UART_UARTLCR_H                  0x2043002c /* Line control register */
#define BCHP_AVS_UART_UARTCR                     0x20430030 /* Control register */
#define BCHP_AVS_UART_UARTIFLS                   0x20430034 /* Interrupt FIFO level select register */
#define BCHP_AVS_UART_UARTIMSC                   0x20430038 /* Interrupt mask set/clear register */
#define BCHP_AVS_UART_UARTRIS                    0x2043003c /* Raw interrupt status register */
#define BCHP_AVS_UART_UARTMIS                    0x20430040 /* Masked interrupt status register */
#define BCHP_AVS_UART_UARTICR                    0x20430044 /* Interrupt clear register */
#define BCHP_AVS_UART_UARTDMACR                  0x20430048 /* DMA control register */
#define BCHP_AVS_UART_UARTPERIPHID0              0x20430fe0 /* UARTPeriphID0 */
#define BCHP_AVS_UART_UARTPERIPHID1              0x20430fe4 /* UARTPeriphID1 */
#define BCHP_AVS_UART_UARTPERIPHID2              0x20430fe8 /* UARTPeriphID2 */
#define BCHP_AVS_UART_UARTPERIPHID3              0x20430fec /* UARTPeriphID3 */
#define BCHP_AVS_UART_UARTPCELLID0               0x20430ff0 /* UARTPCellID0 */
#define BCHP_AVS_UART_UARTPCELLID1               0x20430ff4 /* UARTPCellID1 */
#define BCHP_AVS_UART_UARTPCELLID2               0x20430ff8 /* UARTPCellID2 */
#define BCHP_AVS_UART_UARTPCELLID3               0x20430ffc /* UARTPCellID3 */
