 ...
 *
 *
 * Date:           Generated on              Thu Oct 16 03:13:09 2014
 ...
 ***************************************************************************/
#define BCHP_XPT_WDMA_CH0_FIRST_DESC_ADDR        0x20a6a000 /* First Descriptor Address */
#define BCHP_XPT_WDMA_CH0_NEXT_DESC_ADDR         0x20a6a004 /* Next Descriptor Address */
#define BCHP_XPT_WDMA_CH0_COMPLETED_DESC_ADDRESS 0x20a6a008 /* Completed Descriptor Address */
#define BCHP_XPT_WDMA_CH0_BTP_PACKET_GROUP_ID    0x20a6a00c /* Packet Group ID reported per BTP command */
#define BCHP_XPT_WDMA_CH0_RUN_VERSION_CONFIG     0x20a6a010 /* RUN_VERSION configuration */
#define BCHP_XPT_WDMA_CH0_OVERFLOW_REASONS       0x20a6a014 /* Overflow Reason */
#define BCHP_XPT_WDMA_CH0_DMQ_CONTROL_STRUCT     0x20a6a018 /* Descriptor Memory Queue Control Structure */
#define BCHP_XPT_WDMA_CH0_DATA_CONTROL           0x20a6a01c /* Data Control */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_BASE_PTR_HI  0x20a6a080 /* DRAM Buffer Base Pointer - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_BASE_PTR     0x20a6a084 /* DRAM Buffer Base Pointer - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_END_PTR_HI   0x20a6a088 /* DRAM Buffer End Pointer - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_END_PTR      0x20a6a08c /* DRAM Buffer End Pointer - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_RD_PTR_HI    0x20a6a090 /* DRAM Buffer Read Pointer - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_RD_PTR       0x20a6a094 /* DRAM Buffer Read Pointer - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_WR_PTR_HI    0x20a6a098 /* DRAM Buffer Write Pointer - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_WR_PTR       0x20a6a09c /* DRAM Buffer Write Pointer - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_VALID_PTR_HI 0x20a6a0a0 /* DRAM Buffer Valid Pointer - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_VALID_PTR    0x20a6a0a4 /* DRAM Buffer Valid Pointer - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_LOWER_THRESHOLD_HI 0x20a6a0a8 /* DRAM Buffer Lower Threshold - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_LOWER_THRESHOLD 0x20a6a0ac /* DRAM Buffer Lower Threshold - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_UPPER_THRESHOLD_HI 0x20a6a0b0 /* DRAM Buffer Upper Threshold - Upper bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_UPPER_THRESHOLD 0x20a6a0b4 /* DRAM Buffer Upper Threshold - Lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_STATUS       0x20a6a0b8 /* DRAM Buffer Status */
#define BCHP_XPT_WDMA_CH0_DRAM_BUFF_CONTROL      0x20a6a0bc /* DRAM Buffer Control */
#define BCHP_XPT_WDMA_CH0_DMQ_0_0                0x20a6a0c0 /* DMQ descriptor 0 - Write Address, Upper bits */
#define BCHP_XPT_WDMA_CH0_DMQ_0_1                0x20a6a0c4 /* DMQ descriptor 0 - Write Address, lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DMQ_0_2                0x20a6a0c8 /* DMQ descriptor 0 - Transfer Size */
#define BCHP_XPT_WDMA_CH0_DMQ_0_3                0x20a6a0cc /* DMQ descriptor 0 - Current Descriptor Address and Control */
#define BCHP_XPT_WDMA_CH0_DMQ_1_0                0x20a6a0d0 /* DMQ descriptor 1 - Write Address, Upper bits */
#define BCHP_XPT_WDMA_CH0_DMQ_1_1                0x20a6a0d4 /* DMQ descriptor 1 - Write Address, lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DMQ_1_2                0x20a6a0d8 /* DMQ descriptor 1 - Transfer Size */
#define BCHP_XPT_WDMA_CH0_DMQ_1_3                0x20a6a0dc /* DMQ descriptor 1 - Current Descriptor Address and Control */
#define BCHP_XPT_WDMA_CH0_DMQ_2_0                0x20a6a0e0 /* DMQ descriptor 2 - Write Address, Upper bits */
#define BCHP_XPT_WDMA_CH0_DMQ_2_1                0x20a6a0e4 /* DMQ descriptor 2 - Write Address, lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DMQ_2_2                0x20a6a0e8 /* DMQ descriptor 2 - Transfer Size */
#define BCHP_XPT_WDMA_CH0_DMQ_2_3                0x20a6a0ec /* DMQ descriptor 2 - Current Descriptor Address and Control */
#define BCHP_XPT_WDMA_CH0_DMQ_3_0                0x20a6a0f0 /* DMQ descriptor 3 - Write Address, Upper bits */
#define BCHP_XPT_WDMA_CH0_DMQ_3_1                0x20a6a0f4 /* DMQ descriptor 3 - Write Address, lower 32 bits */
#define BCHP_XPT_WDMA_CH0_DMQ_3_2                0x20a6a0f8 /* DMQ descriptor 3 - Transfer Size */
#define BCHP_XPT_WDMA_CH0_DMQ_3_3                0x20a6a0fc /* DMQ descriptor 3 - Current Descriptor Address and Control */
