 ...
 ***************************************************************************/
#define BCHP_SDIO_0_HOST_SDMA                    0x204a0000 /* System DMA Address Register */
#define BCHP_SDIO_0_HOST_BLOCK                   0x204a0004 /* Block Reset and Count Register */
#define BCHP_SDIO_0_HOST_ARGUMENT                0x204a0008 /* Argument Register */
#define BCHP_SDIO_0_HOST_CMD_MODE                0x204a000c /* Command and Mode Register */
#define BCHP_SDIO_0_HOST_RESP_01                 0x204a0010 /* Response Word 0 and 1 */
#define BCHP_SDIO_0_HOST_RESP_23                 0x204a0014 /* Response Word 2 and 3 */
#define BCHP_SDIO_0_HOST_RESP_45                 0x204a0018 /* Response Word 4 and 5 */
#define BCHP_SDIO_0_HOST_RESP_67                 0x204a001c /* Response Word 6 and 7 */
#define BCHP_SDIO_0_HOST_BUFFDATA                0x204a0020 /* Buffer Data Port for PIO Tranfers */
#define BCHP_SDIO_0_HOST_STATE                   0x204a0024 /* Present State of Controller */
#define BCHP_SDIO_0_HOST_CTRL_SET0               0x204a0028 /* SD Standard Control Registers for Host, Power, BlockGap, WakeUp */
#define BCHP_SDIO_0_HOST_CTRL_SET1               0x204a002c /* SD Standard Control Registers for Clock, Timeout, Resets */
#define BCHP_SDIO_0_HOST_INT_STATUS              0x204a0030 /* Interrupt Status for Normal and Error conditions */
#define BCHP_SDIO_0_HOST_INT_STATUS_ENA          0x204a0034 /* Interrupt Enables for Normal and Error conditions */
#define BCHP_SDIO_0_HOST_INT_SIGNAL_ENA          0x204a0038 /* Interrupt Signal Enables for Normal and Error conditions */
#define BCHP_SDIO_0_HOST_AUTOCMD12_STAT          0x204a003c /* Auto Cmd12 Error Status */
#define BCHP_SDIO_0_HOST_CAPABLE                 0x204a0040 /* Host Controller Capabilities to Software */
#define BCHP_SDIO_0_HOST_CAPABLE_1               0x204a0044 /* Future Host Controller Capabilities to Software */
#define BCHP_SDIO_0_HOST_POWER_CAPABLE           0x204a0048 /* Host Controller Power Capabilities to Software */
#define BCHP_SDIO_0_HOST_POWER_CAPABLE_RSVD      0x204a004c /* Future Host Controller Power Capabilities to Software */
#define BCHP_SDIO_0_HOST_FORCE_EVENTS            0x204a0050 /* Force Events on Error Status Bits */
#define BCHP_SDIO_0_HOST_ADMA_ERR_STAT           0x204a0054 /* ADMA Error Status Bits */
#define BCHP_SDIO_0_HOST_ADMA_SYSADDR_LO         0x204a0058 /* ADMA System Address Low Bits */
#define BCHP_SDIO_0_HOST_ADMA_SYSADDR_HI         0x204a005c /* ADMA System Address High Bits */
#define BCHP_SDIO_0_HOST_PRESET_INIT_DEFAULT     0x204a0060 /* Preset Values for init and default speed */
#define BCHP_SDIO_0_HOST_PRESET_HIGH_SPEED       0x204a0064 /* Preset Values for high speed and SDR12 */
#define BCHP_SDIO_0_HOST_PRESET_SDR25_50         0x204a0068 /* Preset Values for SDR25 and SDR50 */
#define BCHP_SDIO_0_HOST_PRESET_SDR104_DDR50     0x204a006c /* Preset Values for SDR104 and DDR50 */
#define BCHP_SDIO_0_HOST_BOOT_TIMEOUT            0x204a0070 /* DAT line inactivity timeout on boot */
#define BCHP_SDIO_0_HOST_DEBUG_SELECT            0x204a0074 /* Debug probe output selection */
#define BCHP_SDIO_0_HOST_SHARED_BUS_CTRL         0x204a00e0 /* shared bus control */
#define BCHP_SDIO_0_HOST_SPI_INTERRUPT           0x204a00f0 /* SPI Interrupt support */
#define BCHP_SDIO_0_HOST_VERSION_STATUS          0x204a00fc /* Controller Version and Slot Status */
