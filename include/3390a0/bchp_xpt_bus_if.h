 ...
 ***************************************************************************/
#define BCHP_XPT_BUS_IF_MISC_CTRL0               0x20a00080 /* Data Transport Misc Control 0 Register */
#define BCHP_XPT_BUS_IF_TEST_MODE                0x20a00084 /* Data transport test register */
#define BCHP_XPT_BUS_IF_REVISION                 0x20a00088 /* Data Transport Revision Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS_REG          0x20a0008c /* Interrupt Status Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS_REG_EN       0x20a00090 /* Interrupt Status Enable Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG         0x20a00094 /* Interrupt Status2 Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS2_REG_EN      0x20a00098 /* Interrupt Status2 Enable Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS3_REG         0x20a0009c /* Interrupt Status3 Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS3_REG_EN      0x20a000a0 /* Interrupt Status3 Enable Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS4_REG         0x20a000a4 /* Interrupt Status4 Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS4_REG_EN      0x20a000a8 /* Interrupt Status4 Enable Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS5_REG         0x20a000ac /* Interrupt Status5 Register */
#define BCHP_XPT_BUS_IF_INTR_STATUS5_REG_EN      0x20a000b0 /* Interrupt Status5 Enable Register */
#define BCHP_XPT_BUS_IF_SUB_MODULE_SOFT_INIT_SET 0x20a000b4 /* Software initialization control for XPT sub-blocks */
#define BCHP_XPT_BUS_IF_SUB_MODULE_SOFT_INIT_CLEAR 0x20a000b8 /* Software initialization control for XPT sub-blocks */
#define BCHP_XPT_BUS_IF_SUB_MODULE_SOFT_INIT_STATUS 0x20a000bc /* Software initialization control for XPT sub-blocks */
#define BCHP_XPT_BUS_IF_SUB_MODULE_SOFT_INIT_DO_MEM_INIT 0x20a000c0 /* Software initialization control for XPT sub-blocks */
#define BCHP_XPT_BUS_IF_XMEMIF_RD_LC_DEBUG_REG_0 0x20a000cc /* LCIF to XMEMIF Debug Registers */
#define BCHP_XPT_BUS_IF_XMEMIF_WR_LC_DEBUG_REG   0x20a000d0 /* LCIF to XMEMIF Debug Registers */
#define BCHP_XPT_BUS_IF_MAX_PLAYBACKS            0x20a000d4 /* Data Transport max number of playbacks supported */
#define BCHP_XPT_BUS_IF_MAX_PID_PARSERS          0x20a000d8 /* Data Transport max number of PID parsers supported */
#define BCHP_XPT_BUS_IF_MAX_PID_CHANNELS         0x20a000dc /* Data Transport max number of PID channels supported excluding MEMDMA */
#define BCHP_XPT_BUS_IF_MEMDMA_MAX_PID_CHANNELS  0x20a000e0 /* Data Transport max number of PID channels supported for MEMDMA */
#define BCHP_XPT_BUS_IF_MAX_INPUT_BANDS          0x20a000e4 /* Data Transport max number of input bands supported */
#define BCHP_XPT_BUS_IF_MAX_PCRS                 0x20a000e8 /* Data Transport max number of PCRs supported */
#define BCHP_XPT_BUS_IF_MAX_TPIT_CHANNELS        0x20a000ec /* Data Transport max number of TPIT channels supported */
#define BCHP_XPT_BUS_IF_MAX_RAVE_CONTEXTS        0x20a000f0 /* Data Transport max number of RAVE contexts supported */
#define BCHP_XPT_BUS_IF_MAX_RMX_CHANNELS         0x20a000f4 /* Data Transport max number of RMX channels supported */
#define BCHP_XPT_BUS_IF_MAX_MSG_BUFFERS          0x20a000f8 /* Data Transport max number of MSG buffers supported */
#define BCHP_XPT_BUS_IF_MAX_SCDS                 0x20a000fc /* Data Transport max number of SCDs supported */
